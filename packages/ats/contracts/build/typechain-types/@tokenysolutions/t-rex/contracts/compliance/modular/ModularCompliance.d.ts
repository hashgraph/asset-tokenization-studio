...
export interface ModularCompliance extends BaseContract {
    ...
    functions: {
        ...
        canTransfer(_from: string, _to: string, _value: BigNumberish, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        canTransfer(_from: string, _to: string, _value: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        created(_to: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        destroyed(_from: string, _value: BigNumberish, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        canTransfer(_from: string, _to: string, _value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        created(_to: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        destroyed(_from: string, _value: BigNumberish, overrides?: Overrides & {
