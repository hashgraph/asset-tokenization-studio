...
export interface ITokenInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "forcedTransfer", values: [string, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "recoveryAddress", values: [string, string, string]): string;
    encodeFunctionData(functionFragment: "setAddressFrozen", values: [string, boolean]): string;
    encodeFunctionData(functionFragment: "setCompliance", values: [string]): string;
    encodeFunctionData(functionFragment: "setIdentityRegistry", values: [string]): string;
    encodeFunctionData(functionFragment: "setName", values: [string]): string;
    encodeFunctionData(functionFragment: "setOnchainID", values: [string]): string;
...
export interface IToken extends BaseContract {
    ...
    functions: {
        ...
        burn(_userAddress: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        compliance(overrides?: CallOverrides): Promise<[string]>;
        decimals(overrides?: CallOverrides): Promise<[number]>;
        forcedTransfer(_from: string, _to: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        recoveryAddress(_lostWallet: string, _newWallet: string, _investorOnchainID: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAddressFrozen(_userAddress: string, _freeze: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setCompliance(_compliance: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setIdentityRegistry(_identityRegistry: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setName(_name: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setOnchainID(_onchainID: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        burn(_userAddress: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        compliance(overrides?: CallOverrides): Promise<string>;
        decimals(overrides?: CallOverrides): Promise<number>;
        forcedTransfer(_from: string, _to: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        ...
        paused(overrides?: CallOverrides): Promise<boolean>;
        recoveryAddress(_lostWallet: string, _newWallet: string, _investorOnchainID: string, overrides?: CallOverrides): Promise<boolean>;
        setAddressFrozen(_userAddress: string, _freeze: boolean, overrides?: CallOverrides): Promise<void>;
        setCompliance(_compliance: string, overrides?: CallOverrides): Promise<void>;
        setIdentityRegistry(_identityRegistry: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "AddressFrozen(address,bool,address)"(_userAddress?: string | null, _isFrozen?: boolean | null, _owner?: string | null): AddressFrozenEventFilter;
        AddressFrozen(_userAddress?: string | null, _isFrozen?: boolean | null, _owner?: string | null): AddressFrozenEventFilter;
        "Approval(address,address,uint256)"(owner?: string | null, spender?: string | null, value?: null): ApprovalEventFilter;
        Approval(owner?: string | null, spender?: string | null, value?: null): ApprovalEventFilter;
        "ComplianceAdded(address)"(_compliance?: string | null): ComplianceAddedEventFilter;
        ComplianceAdded(_compliance?: string | null): ComplianceAddedEventFilter;
        "IdentityRegistryAdded(address)"(_identityRegistry?: string | null): IdentityRegistryAddedEventFilter;
        IdentityRegistryAdded(_identityRegistry?: string | null): IdentityRegistryAddedEventFilter;
        "Paused(address)"(_userAddress?: null): PausedEventFilter;
        Paused(_userAddress?: null): PausedEventFilter;
        "RecoverySuccess(address,address,address)"(_lostWallet?: string | null, _newWallet?: string | null, _investorOnchainID?: string | null): RecoverySuccessEventFilter;
        RecoverySuccess(_lostWallet?: string | null, _newWallet?: string | null, _investorOnchainID?: string | null): RecoverySuccessEventFilter;
        "TokensFrozen(address,uint256)"(_userAddress?: string | null, _amount?: null): TokensFrozenEventFilter;
        TokensFrozen(_userAddress?: string | null, _amount?: null): TokensFrozenEventFilter;
        "TokensUnfrozen(address,uint256)"(_userAddress?: string | null, _amount?: null): TokensUnfrozenEventFilter;
        TokensUnfrozen(_userAddress?: string | null, _amount?: null): TokensUnfrozenEventFilter;
        ...
        "UpdatedTokenInformation(string,string,uint8,string,address)"(_newName?: string | null, _newSymbol?: string | null, _newDecimals?: null, _newVersion?: null, _newOnchainID?: string | null): UpdatedTokenInformationEventFilter;
        UpdatedTokenInformation(_newName?: string | null, _newSymbol?: string | null, _newDecimals?: null, _newVersion?: null, _newOnchainID?: string | null): UpdatedTokenInformationEventFilter;
    };
    estimateGas: {
        allowance(owner: string, spender: string, overrides?: CallOverrides): Promise<BigNumber>;
        approve(spender: string, amount: BigNumberish, overrides?: Overrides & {
        ...
        isFrozen(_userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
        mint(_to: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isFrozen(_userAddress: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mint(_to: string, _amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
