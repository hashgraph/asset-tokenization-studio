...
export interface IdentityRegistry extends BaseContract {
    ...
    functions: {
        ...
        init(_trustedIssuersRegistry: string, _claimTopicsRegistry: string, _identityStorage: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        identity(_userAddress: string, overrides?: CallOverrides): Promise<string>;
        identityStorage(overrides?: CallOverrides): Promise<string>;
        init(_trustedIssuersRegistry: string, _claimTopicsRegistry: string, _identityStorage: string, overrides?: CallOverrides): Promise<void>;
        investorCountry(_userAddress: string, overrides?: CallOverrides): Promise<number>;
        isAgent(_agent: string, overrides?: CallOverrides): Promise<boolean>;
        isVerified(_userAddress: string, overrides?: CallOverrides): Promise<boolean>;
        issuersRegistry(overrides?: CallOverrides): Promise<string>;
