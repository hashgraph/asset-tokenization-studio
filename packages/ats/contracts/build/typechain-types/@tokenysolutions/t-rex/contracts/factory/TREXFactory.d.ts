...
export interface TREXFactory extends BaseContract {
    ...
    functions: {
        ...
        setIdFactory(idFactory_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setImplementationAuthority(implementationAuthority_: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setIdFactory(idFactory_: string, overrides?: CallOverrides): Promise<void>;
        setImplementationAuthority(implementationAuthority_: string, overrides?: CallOverrides): Promise<void>;
        tokenDeployed(arg0: string, overrides?: CallOverrides): Promise<string>;
