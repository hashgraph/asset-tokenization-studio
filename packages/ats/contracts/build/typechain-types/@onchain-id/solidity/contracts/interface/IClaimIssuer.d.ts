...
export interface IClaimIssuer extends BaseContract {
    ...
    functions: {
        ...
        addKey(_key: BytesLike, _purpose: BigNumberish, _keyType: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        addKey(_key: BytesLike, _purpose: BigNumberish, _keyType: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
