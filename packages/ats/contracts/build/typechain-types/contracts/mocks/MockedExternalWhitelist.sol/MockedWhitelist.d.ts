...
export interface MockedWhitelist extends BaseContract {
    ...
    functions: {
        addToWhitelist(account: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        isAuthorized(account: string, overrides?: CallOverrides): Promise<[boolean]>;
        removeFromWhitelist(account: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    addToWhitelist(account: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        isAuthorized(account: string, overrides?: CallOverrides): Promise<boolean>;
        removeFromWhitelist(account: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "AddedToWhitelist(address)"(account?: string | null): AddedToWhitelistEventFilter;
        AddedToWhitelist(account?: string | null): AddedToWhitelistEventFilter;
        "RemovedFromWhitelist(address)"(account?: string | null): RemovedFromWhitelistEventFilter;
        RemovedFromWhitelist(account?: string | null): RemovedFromWhitelistEventFilter;
    };
    estimateGas: {
        addToWhitelist(account: string, overrides?: Overrides & {
            from?: string;
