...
export interface IStaticFunctionSelectors_Interface extends utils.Interface {
    functions: {
...
export interface IStaticFunctionSelectors_ extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IStaticFunctionSelectors_Interface;
