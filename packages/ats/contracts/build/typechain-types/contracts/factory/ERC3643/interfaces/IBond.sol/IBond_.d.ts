...
export declare namespace IBond_ {
    ...
    type RegisteredCouponStructOutput = [
        ...
        coupon: IBond_.CouponStructOutput;
...
export interface IBond_Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setCoupon", values: [IBond_.CouponStruct]): string;
...
export interface IBond_ extends BaseContract {
    ...
    functions: {
        ...
        setCoupon(_newCoupon: IBond_.CouponStruct, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    getBondDetails(overrides?: CallOverrides): Promise<IBond_.BondDetailsDataStructOutput>;
    getCoupon(_couponID: BigNumberish, overrides?: CallOverrides): Promise<IBond_.RegisteredCouponStructOutput>;
    getCouponCount(overrides?: CallOverrides): Promise<BigNumber>;
    getCouponDetails(overrides?: CallOverrides): Promise<IBond_.CouponDetailsDataStructOutput>;
    getCouponFor(_couponID: BigNumberish, _account: string, overrides?: CallOverrides): Promise<IBond_.CouponForStructOutput>;
    getCouponHolders(_couponID: BigNumberish, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
    getTotalCouponHolders(_couponID: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    redeemAtMaturityByPartition(_tokenHolder: string, _partition: BytesLike, _amount: BigNumberish, overrides?: Overrides & {
        from?: string;
    ...
    callStatic: {
        ...
        setCoupon(_newCoupon: IBond_.CouponStruct, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
