...
export interface IScheduledTasksInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getScheduledTasks", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "onScheduledTaskTriggered", values: [BigNumberish, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "triggerScheduledTasks", values: [BigNumberish]): string;
...
export interface IScheduledTasks extends BaseContract {
    ...
    functions: {
        getScheduledTasks(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[
            ScheduledTasksLib.ScheduledTaskStructOutput[]
        ] & {
            scheduledTask_: ScheduledTasksLib.ScheduledTaskStructOutput[];
        }>;
        onScheduledTaskTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        ...
        triggerScheduledTasks(_max: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    getScheduledTasks(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
    onScheduledTaskTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    scheduledTaskCount(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        getScheduledTasks(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
        onScheduledTaskTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        scheduledTaskCount(overrides?: CallOverrides): Promise<BigNumber>;
        triggerPendingScheduledTasks(overrides?: CallOverrides): Promise<BigNumber>;
        triggerScheduledTasks(_max: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
        getScheduledTasks(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        onScheduledTaskTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        scheduledTaskCount(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        getScheduledTasks(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        onScheduledTaskTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
