...
export interface IScheduledSnapshotsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getScheduledSnapshots", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "onScheduledSnapshotTriggered", values: [BigNumberish, BigNumberish, BytesLike]): string;
...
export interface IScheduledSnapshots extends BaseContract {
    ...
    functions: {
        getScheduledSnapshots(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[
            ScheduledTasksLib.ScheduledTaskStructOutput[]
        ] & {
            scheduledSnapshot_: ScheduledTasksLib.ScheduledTaskStructOutput[];
        }>;
        onScheduledSnapshotTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        scheduledSnapshotCount(overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    getScheduledSnapshots(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
    onScheduledSnapshotTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    scheduledSnapshotCount(overrides?: CallOverrides): Promise<BigNumber>;
    callStatic: {
        getScheduledSnapshots(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
        onScheduledSnapshotTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        scheduledSnapshotCount(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
        getScheduledSnapshots(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        onScheduledSnapshotTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        scheduledSnapshotCount(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        getScheduledSnapshots(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        onScheduledSnapshotTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
