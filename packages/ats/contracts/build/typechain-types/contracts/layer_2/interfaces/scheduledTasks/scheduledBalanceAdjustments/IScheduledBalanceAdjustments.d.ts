...
export interface IScheduledBalanceAdjustmentsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getScheduledBalanceAdjustments", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "onScheduledBalanceAdjustmentTriggered", values: [BigNumberish, BigNumberish, BytesLike]): string;
...
export interface IScheduledBalanceAdjustments extends BaseContract {
    ...
    functions: {
        getScheduledBalanceAdjustments(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[
            ScheduledTasksLib.ScheduledTaskStructOutput[]
        ] & {
            scheduledBalanceAdjustment_: ScheduledTasksLib.ScheduledTaskStructOutput[];
        }>;
        onScheduledBalanceAdjustmentTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        scheduledBalanceAdjustmentCount(overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    getScheduledBalanceAdjustments(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
    onScheduledBalanceAdjustmentTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    scheduledBalanceAdjustmentCount(overrides?: CallOverrides): Promise<BigNumber>;
    callStatic: {
        getScheduledBalanceAdjustments(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<ScheduledTasksLib.ScheduledTaskStructOutput[]>;
        onScheduledBalanceAdjustmentTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        scheduledBalanceAdjustmentCount(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
        getScheduledBalanceAdjustments(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        onScheduledBalanceAdjustmentTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        scheduledBalanceAdjustmentCount(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        getScheduledBalanceAdjustments(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        onScheduledBalanceAdjustmentTriggered(_pos: BigNumberish, _scheduledTasksLength: BigNumberish, _data: BytesLike, overrides?: Overrides & {
            from?: string;
