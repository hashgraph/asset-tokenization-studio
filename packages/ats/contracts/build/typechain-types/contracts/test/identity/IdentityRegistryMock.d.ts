...
export interface IdentityRegistryMock extends BaseContract {
    ...
    functions: {
        ...
        setFlags(_isVerifiedFlag: boolean, _revertFlag: boolean, overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        isVerified(_userAddress: string, overrides?: CallOverrides): Promise<boolean>;
        setFlags(_isVerifiedFlag: boolean, _revertFlag: boolean, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
