...
export interface ERC3643TimeTravelInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addAgent" | "burn" | "compliance" | "forcedTransfer" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "identityRegistry" | "initialize_ERC3643" | "isAddressRecovered" | "isAgent" | "mint" | "onchainID" | "recoveryAddress" | "removeAgent" | "setCompliance" | "setIdentityRegistry" | "setName" | "setOnchainID" | "setSymbol" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "initialize_ERC3643", values: [string, string]): string;
    encodeFunctionData(functionFragment: "isAddressRecovered", values: [string]): string;
...
export interface ERC3643TimeTravel extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC3643TimeTravelInterface;
    ...
    functions: {
        ...
        initialize_ERC3643(_compliance: string, _identityRegistry: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        isAddressRecovered(_wallet: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    callStatic: {
        ...
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        identityRegistry(overrides?: CallOverrides): Promise<string>;
        initialize_ERC3643(_compliance: string, _identityRegistry: string, overrides?: CallOverrides): Promise<void>;
        isAddressRecovered(_wallet: string, overrides?: CallOverrides): Promise<boolean>;
        isAgent(_agent: string, overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {
        ...
        "IdentityRegistryAdded(address)"(identityRegistry?: string | null): IdentityRegistryAddedEventFilter;
        IdentityRegistryAdded(identityRegistry?: string | null): IdentityRegistryAddedEventFilter;
        ...
        "UpdatedTokenInformation(string,string,uint8,string,address)"(newName?: string | null, newSymbol?: string | null, newDecimals?: null, newVersion?: null, newOnchainID?: string | null): UpdatedTokenInformationEventFilter;
        UpdatedTokenInformation(newName?: string | null, newSymbol?: string | null, newDecimals?: null, newVersion?: null, newOnchainID?: string | null): UpdatedTokenInformationEventFilter;
    };
    estimateGas: {
        addAgent(_agent: string, overrides?: Overrides & {
            from?: string;
        ...
        isAddressRecovered(_wallet: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isAddressRecovered(_wallet: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
