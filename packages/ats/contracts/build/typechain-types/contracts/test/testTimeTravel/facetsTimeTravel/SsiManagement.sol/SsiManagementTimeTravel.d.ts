...
export interface SsiManagementTimeTravelInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getIssuerListMembers", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "removeIssuer", values: [string]): string;
    encodeFunctionData(functionFragment: "setRevocationRegistryAddress", values: [string]): string;
...
export interface SsiManagementTimeTravel extends BaseContract {
    ...
    functions: {
        addIssuer(_issuer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        getIssuerListCount(overrides?: CallOverrides): Promise<[BigNumber] & {
            issuerListCount_: BigNumber;
        }>;
        getIssuerListMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[string[]] & {
            members_: string[];
        }>;
        ...
        removeIssuer(_issuer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setRevocationRegistryAddress(_revocationRegistryAddress: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    addIssuer(_issuer: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        setRevocationRegistryAddress(_revocationRegistryAddress: string, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        "AddedToIssuerList(address,address)"(operator?: string | null, issuer?: string | null): AddedToIssuerListEventFilter;
        AddedToIssuerList(operator?: string | null, issuer?: string | null): AddedToIssuerListEventFilter;
        ...
        "RemovedFromIssuerList(address,address)"(operator?: string | null, issuer?: string | null): RemovedFromIssuerListEventFilter;
        RemovedFromIssuerList(operator?: string | null, issuer?: string | null): RemovedFromIssuerListEventFilter;
        "RevocationRegistryUpdated(address,address)"(oldRegistryAddress?: string | null, newRegistryAddress?: string | null): RevocationRegistryUpdatedEventFilter;
        RevocationRegistryUpdated(oldRegistryAddress?: string | null, newRegistryAddress?: string | null): RevocationRegistryUpdatedEventFilter;
    ...
    estimateGas: {
        ...
        getIssuerListCount(overrides?: CallOverrides): Promise<BigNumber>;
        getIssuerListMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getIssuerListMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        isIssuer(_issuer: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        removeIssuer(_issuer: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        setRevocationRegistryAddress(_revocationRegistryAddress: string, overrides?: Overrides & {
