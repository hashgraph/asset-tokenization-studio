...
export interface TimeTravelInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "blockTimestamp" | "changeSystemTimestamp" | "checkBlockChainid" | "getStaticFunctionSelectors" | "getStaticInterfaceIds" | "getStaticResolverKey" | "resetSystemTimestamp"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "checkBlockChainid", values: [BigNumberish]): string;
...
export interface TimeTravel extends BaseContract {
    ...
    functions: {
        ...
        changeSystemTimestamp(newTimestamp: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        checkBlockChainid(chainId: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
    ...
    callStatic: {
        blockTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
        changeSystemTimestamp(newTimestamp: BigNumberish, overrides?: CallOverrides): Promise<void>;
        checkBlockChainid(chainId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        getStaticFunctionSelectors(overrides?: CallOverrides): Promise<string[]>;
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        checkBlockChainid(chainId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        checkBlockChainid(chainId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
