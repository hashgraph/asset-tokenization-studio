...
export interface CorporateActionsTimeTravelInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addCorporateAction", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "getCorporateAction", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "getCorporateActionCount", values?: undefined): string;
    encodeFunctionData(functionFragment: "getCorporateActionCountByType", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "getCorporateActionIds", values: [BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getCorporateActionIdsByType", values: [BytesLike, BigNumberish, BigNumberish]): string;
...
export interface CorporateActionsTimeTravel extends BaseContract {
    ...
    functions: {
        addCorporateAction(_actionType: BytesLike, _data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        getCorporateAction(_corporateActionId: BytesLike, overrides?: CallOverrides): Promise<[string, string] & {
            actionType_: string;
            data_: string;
        }>;
        ...
        getCorporateActionCountByType(_actionType: BytesLike, overrides?: CallOverrides): Promise<[BigNumber] & {
            corporateActionCount_: BigNumber;
        }>;
        getCorporateActionIds(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[string[]] & {
            corporateActionIds_: string[];
        }>;
        getCorporateActionIdsByType(_actionType: BytesLike, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[string[]] & {
            corporateActionIds_: string[];
        }>;
    ...
    getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        addCorporateAction(_actionType: BytesLike, _data: BytesLike, overrides?: CallOverrides): Promise<[
            boolean,
            string,
            BigNumber
        ] & {
    ...
    filters: {
        ...
        "CorporateActionAdded(address,bytes32,bytes32,uint256,bytes)"(operator?: string | null, actionType?: BytesLike | null, corporateActionId?: BytesLike | null, corporateActionIndexByType?: null, data?: null): CorporateActionAddedEventFilter;
        CorporateActionAdded(operator?: string | null, actionType?: BytesLike | null, corporateActionId?: BytesLike | null, corporateActionIndexByType?: null, data?: null): CorporateActionAddedEventFilter;
    ...
    estimateGas: {
        ...
        getCorporateAction(_corporateActionId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        getCorporateActionCount(overrides?: CallOverrides): Promise<BigNumber>;
        getCorporateActionCountByType(_actionType: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        getCorporateActionIds(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getCorporateActionIdsByType(_actionType: BytesLike, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getCorporateAction(_corporateActionId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getCorporateActionCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getCorporateActionCountByType(_actionType: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getCorporateActionIds(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getCorporateActionIdsByType(_actionType: BytesLike, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
