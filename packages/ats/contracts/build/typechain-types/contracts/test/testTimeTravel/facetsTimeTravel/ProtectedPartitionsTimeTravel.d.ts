...
export interface ProtectedPartitionsTimeTravel extends BaseContract {
    ...
    functions: {
        ...
        calculateRoleForPartition(partition: BytesLike, overrides?: CallOverrides): Promise<[string] & {
            role: string;
        }>;
        ...
        initialize_ProtectedPartitions(_protectPartitions: boolean, overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        ...
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        initialize_ProtectedPartitions(_protectPartitions: boolean, overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        calculateRoleForPartition(partition: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        getNounceFor(account: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        calculateRoleForPartition(partition: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
