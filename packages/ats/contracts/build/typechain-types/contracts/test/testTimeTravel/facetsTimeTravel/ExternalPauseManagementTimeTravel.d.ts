...
export interface ExternalPauseManagementTimeTravelInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addExternalPause", values: [string]): string;
    encodeFunctionData(functionFragment: "getExternalPausesCount", values?: undefined): string;
    encodeFunctionData(functionFragment: "getExternalPausesMembers", values: [BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "initialize_ExternalPauses", values: [string[]]): string;
    encodeFunctionData(functionFragment: "isExternalPause", values: [string]): string;
    encodeFunctionData(functionFragment: "removeExternalPause", values: [string]): string;
    encodeFunctionData(functionFragment: "updateExternalPauses", values: [string[], boolean[]]): string;
...
export interface ExternalPauseManagementTimeTravel extends BaseContract {
    ...
    functions: {
        addExternalPause(_pause: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        getExternalPausesCount(overrides?: CallOverrides): Promise<[BigNumber] & {
            externalPausesCount_: BigNumber;
        }>;
        getExternalPausesMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[string[]] & {
            members_: string[];
        }>;
        ...
        initialize_ExternalPauses(_pauses: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        isExternalPause(_pause: string, overrides?: CallOverrides): Promise<[boolean]>;
        removeExternalPause(_pause: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        updateExternalPauses(_pauses: string[], _actives: boolean[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    addExternalPause(_pause: string, overrides?: Overrides & {
    ...
    callStatic: {
        addExternalPause(_pause: string, overrides?: CallOverrides): Promise<boolean>;
        getExternalPausesCount(overrides?: CallOverrides): Promise<BigNumber>;
        getExternalPausesMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        getStaticFunctionSelectors(overrides?: CallOverrides): Promise<string[]>;
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        initialize_ExternalPauses(_pauses: string[], overrides?: CallOverrides): Promise<void>;
        isExternalPause(_pause: string, overrides?: CallOverrides): Promise<boolean>;
        removeExternalPause(_pause: string, overrides?: CallOverrides): Promise<boolean>;
        updateExternalPauses(_pauses: string[], _actives: boolean[], overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        "AddedToExternalPauses(address,address)"(operator?: string | null, pause?: null): AddedToExternalPausesEventFilter;
        AddedToExternalPauses(operator?: string | null, pause?: null): AddedToExternalPausesEventFilter;
        ...
        "ExternalPausesUpdated(address,address[],bool[])"(operator?: string | null, pauses?: null, actives?: null): ExternalPausesUpdatedEventFilter;
        ExternalPausesUpdated(operator?: string | null, pauses?: null, actives?: null): ExternalPausesUpdatedEventFilter;
        ...
        "RemovedFromExternalPauses(address,address)"(operator?: string | null, pause?: null): RemovedFromExternalPausesEventFilter;
        RemovedFromExternalPauses(operator?: string | null, pause?: null): RemovedFromExternalPausesEventFilter;
    ...
    estimateGas: {
        ...
        getExternalPausesCount(overrides?: CallOverrides): Promise<BigNumber>;
        getExternalPausesMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        isExternalPause(_pause: string, overrides?: CallOverrides): Promise<BigNumber>;
        removeExternalPause(_pause: string, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        updateExternalPauses(_pauses: string[], _actives: boolean[], overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        getExternalPausesMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        isExternalPause(_pause: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        removeExternalPause(_pause: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        updateExternalPauses(_pauses: string[], _actives: boolean[], overrides?: Overrides & {
