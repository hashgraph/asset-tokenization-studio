...
export interface ERC1594 extends BaseContract {
    ...
    functions: {
        ...
        transferFromWithData(_from: string, _to: string, _value: BigNumberish, arg3: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        transferWithData(_to: string, _value: BigNumberish, arg2: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    canTransfer(_to: string, _value: BigNumberish, _data: BytesLike, overrides?: CallOverrides): Promise<[boolean, string, string]>;
    ...
    callStatic: {
        ...
        transferFromWithData(_from: string, _to: string, _value: BigNumberish, arg3: BytesLike, overrides?: CallOverrides): Promise<void>;
        transferWithData(_to: string, _value: BigNumberish, arg2: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
