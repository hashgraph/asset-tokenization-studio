...
export interface ClearingReadFacet extends BaseContract {
    ...
    functions: {
        ...
        getClearingThirdParty(_partition: BytesLike, _tokenHolder: string, _clearingOpeartionType: BigNumberish, _clearingId: BigNumberish, overrides?: CallOverrides): Promise<[string] & {
            thirdParty_: string;
        }>;
    ...
    estimateGas: {
        ...
        getClearedAmountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getClearingCountForByPartition(_partition: BytesLike, _tokenHolder: string, _clearingOperationType: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getClearingThirdParty(_partition: BytesLike, _tokenHolder: string, _clearingOpeartionType: BigNumberish, _clearingId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getClearingsIdForByPartition(_partition: BytesLike, _tokenHolder: string, _clearingOperationType: BigNumberish, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getClearingThirdParty(_partition: BytesLike, _tokenHolder: string, _clearingOpeartionType: BigNumberish, _clearingId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
