...
export interface IERC1643Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getDocument", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "removeDocument", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "setDocument", values: [BytesLike, string, BytesLike]): string;
...
export interface IERC1643 extends BaseContract {
    ...
    functions: {
        ...
        getDocument(_name: BytesLike, overrides?: CallOverrides): Promise<[string, string, BigNumber]>;
        removeDocument(_name: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setDocument(_name: BytesLike, _uri: string, _documentHash: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    getAllDocuments(overrides?: CallOverrides): Promise<string[]>;
    ...
    callStatic: {
        ...
        setDocument(_name: BytesLike, _uri: string, _documentHash: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "DocumentRemoved(bytes32,string,bytes32)"(name?: BytesLike | null, uri?: null, documentHash?: null): DocumentRemovedEventFilter;
        DocumentRemoved(name?: BytesLike | null, uri?: null, documentHash?: null): DocumentRemovedEventFilter;
        "DocumentUpdated(bytes32,string,bytes32)"(name?: BytesLike | null, uri?: null, documentHash?: null): DocumentUpdatedEventFilter;
        DocumentUpdated(name?: BytesLike | null, uri?: null, documentHash?: null): DocumentUpdatedEventFilter;
    };
    estimateGas: {
        getAllDocuments(overrides?: CallOverrides): Promise<BigNumber>;
        getDocument(_name: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        removeDocument(_name: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        setDocument(_name: BytesLike, _uri: string, _documentHash: BytesLike, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        getDocument(_name: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        removeDocument(_name: BytesLike, overrides?: Overrides & {
            from?: string;
