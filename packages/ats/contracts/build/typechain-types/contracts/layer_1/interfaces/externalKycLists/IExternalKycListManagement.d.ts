...
export interface IExternalKycListManagement extends BaseContract {
    ...
    functions: {
        addExternalKycList(_kycList: string, overrides?: Overrides & {
            from?: string;
        ...
        removeExternalKycList(_kycList: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        addExternalKycList(_kycList: string, overrides?: CallOverrides): Promise<boolean>;
        getExternalKycListsCount(overrides?: CallOverrides): Promise<BigNumber>;
        getExternalKycListsMembers(_pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        initialize_ExternalKycLists(_kycLists: string[], overrides?: CallOverrides): Promise<void>;
        isExternalKycList(_kycList: string, overrides?: CallOverrides): Promise<boolean>;
        isExternallyGranted(_account: string, _kycStatus: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        removeExternalKycList(_kycList: string, overrides?: CallOverrides): Promise<boolean>;
