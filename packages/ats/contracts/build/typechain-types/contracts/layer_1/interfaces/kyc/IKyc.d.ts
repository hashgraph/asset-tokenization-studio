...
export interface IKyc extends BaseContract {
    ...
    functions: {
        ...
        initializeInternalKyc(_activateInternalKyc: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initializeInternalKyc(_activateInternalKyc: boolean, overrides?: CallOverrides): Promise<void>;
        isInternalKycActivated(overrides?: CallOverrides): Promise<boolean>;
