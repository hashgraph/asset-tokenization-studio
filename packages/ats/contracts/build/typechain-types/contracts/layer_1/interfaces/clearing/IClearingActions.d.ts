...
export declare namespace IClearing {
    type ClearingOperationIdentifierStruct = {
        clearingOperationType: BigNumberish;
        partition: BytesLike;
        tokenHolder: string;
        clearingId: BigNumberish;
    };
...
export interface IClearingActionsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "initializeClearing", values: [boolean]): string;
...
export interface IClearingActions extends BaseContract {
    ...
    functions: {
        ...
        initializeClearing(_activateClearing: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initializeClearing(_activateClearing: boolean, overrides?: CallOverrides): Promise<void>;
        isClearingActivated(overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {
        "ClearingActivated(address)"(operator?: string | null): ClearingActivatedEventFilter;
        ClearingActivated(operator?: string | null): ClearingActivatedEventFilter;
        "ClearingDeactivated(address)"(operator?: string | null): ClearingDeactivatedEventFilter;
        ClearingDeactivated(operator?: string | null): ClearingDeactivatedEventFilter;
        "ClearingOperationApproved(address,address,bytes32,uint256,uint8)"(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationApprovedEventFilter;
        ClearingOperationApproved(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationApprovedEventFilter;
        "ClearingOperationCanceled(address,address,bytes32,uint256,uint8)"(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationCanceledEventFilter;
        ClearingOperationCanceled(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationCanceledEventFilter;
        "ClearingOperationReclaimed(address,address,bytes32,uint256,uint8)"(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationReclaimedEventFilter;
        ClearingOperationReclaimed(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, clearingId?: null, clearingOperationType?: null): ClearingOperationReclaimedEventFilter;
    };
    estimateGas: {
        activateClearing(overrides?: Overrides & {
            from?: string;
