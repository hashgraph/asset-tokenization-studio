...
export interface IERC1644Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "controllerRedeem", values: [string, BigNumberish, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "controllerTransfer", values: [string, string, BigNumberish, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "finalizeControllable", values?: undefined): string;
    encodeFunctionData(functionFragment: "initialize_ERC1644", values: [boolean]): string;
...
export interface IERC1644 extends BaseContract {
    ...
    functions: {
        controllerRedeem(_tokenHolder: string, _value: BigNumberish, _data: BytesLike, _operatorData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        controllerTransfer(_from: string, _to: string, _value: BigNumberish, _data: BytesLike, _operatorData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        finalizeControllable(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        initialize_ERC1644(_isControllable: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    isControllable(overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        controllerRedeem(_tokenHolder: string, _value: BigNumberish, _data: BytesLike, _operatorData: BytesLike, overrides?: CallOverrides): Promise<void>;
        controllerTransfer(_from: string, _to: string, _value: BigNumberish, _data: BytesLike, _operatorData: BytesLike, overrides?: CallOverrides): Promise<void>;
        finalizeControllable(overrides?: CallOverrides): Promise<void>;
        initialize_ERC1644(_isControllable: boolean, overrides?: CallOverrides): Promise<void>;
        isControllable(overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
    estimateGas: {
