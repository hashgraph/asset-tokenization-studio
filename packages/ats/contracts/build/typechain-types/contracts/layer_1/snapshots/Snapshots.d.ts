...
export interface SnapshotsInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "balanceOfAtSnapshot", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "balanceOfAtSnapshotByPartition", values: [BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "clearedBalanceOfAtSnapshot", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "clearedBalanceOfAtSnapshotByPartition", values: [BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "decimalsAtSnapshot", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getTokenHoldersAtSnapshot", values: [BigNumberish, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getTotalTokenHoldersAtSnapshot", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "heldBalanceOfAtSnapshot", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "heldBalanceOfAtSnapshotByPartition", values: [BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "lockedBalanceOfAtSnapshot", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "lockedBalanceOfAtSnapshotByPartition", values: [BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "partitionsOfAtSnapshot", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "takeSnapshot", values?: undefined): string;
    encodeFunctionData(functionFragment: "totalSupplyAtSnapshot", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "totalSupplyAtSnapshotByPartition", values: [BytesLike, BigNumberish]): string;
...
export interface Snapshots extends BaseContract {
    ...
    functions: {
        balanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        balanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        clearedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        clearedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        decimalsAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<[number] & {
            decimals_: number;
        }>;
        ...
        getTokenHoldersAtSnapshot(_snapshotID: BigNumberish, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[string[]] & {
            holders_: string[];
        }>;
        getTotalTokenHoldersAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
        heldBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        heldBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        lockedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        lockedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            balance_: BigNumber;
        }>;
        partitionsOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<[string[]]>;
        takeSnapshot(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        totalSupplyAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
            totalSupply_: BigNumber;
        }>;
        totalSupplyAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber] & {
            totalSupply_: BigNumber;
        }>;
    };
    balanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    estimateGas: {
        ...
        clearedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        clearedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        decimalsAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        getTokenHoldersAtSnapshot(_snapshotID: BigNumberish, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getTotalTokenHoldersAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        heldBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        heldBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        lockedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        lockedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        partitionsOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        takeSnapshot(overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        totalSupplyAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        balanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        balanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        clearedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        clearedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        decimalsAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getTokenHoldersAtSnapshot(_snapshotID: BigNumberish, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getTotalTokenHoldersAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        heldBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        heldBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        lockedBalanceOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        lockedBalanceOfAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        partitionsOfAtSnapshot(_snapshotID: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        takeSnapshot(overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        totalSupplyAtSnapshot(_snapshotID: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        totalSupplyAtSnapshotByPartition(_partition: BytesLike, _snapshotID: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
