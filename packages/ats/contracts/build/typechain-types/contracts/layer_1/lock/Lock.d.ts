...
export interface LockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getLockCountFor", values: [string]): string;
    encodeFunctionData(functionFragment: "getLockCountForByPartition", values: [BytesLike, string]): string;
    encodeFunctionData(functionFragment: "getLockFor", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getLockForByPartition", values: [BytesLike, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getLockedAmountFor", values: [string]): string;
    encodeFunctionData(functionFragment: "getLockedAmountForByPartition", values: [BytesLike, string]): string;
    encodeFunctionData(functionFragment: "getLocksIdFor", values: [string, BigNumberish, BigNumberish]): string;
    encodeFunctionData(functionFragment: "getLocksIdForByPartition", values: [BytesLike, string, BigNumberish, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "lock", values: [BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "lockByPartition", values: [BytesLike, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "release", values: [BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "releaseByPartition", values: [BytesLike, BigNumberish, string]): string;
...
export interface Lock extends BaseContract {
    ...
    functions: {
        getLockCountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            lockCount_: BigNumber;
        }>;
        getLockCountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            lockCount_: BigNumber;
        }>;
        getLockFor(_tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            amount_: BigNumber;
        ...
        getLockForByPartition(_partition: BytesLike, _tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
            amount_: BigNumber;
        ...
        getLockedAmountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            amount_: BigNumber;
        }>;
        getLockedAmountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            amount_: BigNumber;
        }>;
        getLocksIdFor(_tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]] & {
            locksId_: BigNumber[];
        }>;
        getLocksIdForByPartition(_partition: BytesLike, _tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]] & {
            locksId_: BigNumber[];
        }>;
        ...
        lock(_amount: BigNumberish, _tokenHolder: string, _expirationTimestamp: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        lockByPartition(_partition: BytesLike, _amount: BigNumberish, _tokenHolder: string, _expirationTimestamp: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        release(_lockId: BigNumberish, _tokenHolder: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        releaseByPartition(_partition: BytesLike, _lockId: BigNumberish, _tokenHolder: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    getLockCountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        getStaticInterfaceIds(overrides?: CallOverrides): Promise<string[]>;
        getStaticResolverKey(overrides?: CallOverrides): Promise<string>;
        lock(_amount: BigNumberish, _tokenHolder: string, _expirationTimestamp: BigNumberish, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
        ...
        lockByPartition(_partition: BytesLike, _amount: BigNumberish, _tokenHolder: string, _expirationTimestamp: BigNumberish, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            success_: boolean;
        ...
        release(_lockId: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<boolean>;
        releaseByPartition(_partition: BytesLike, _lockId: BigNumberish, _tokenHolder: string, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        ...
        "LockByPartitionReleased(address,address,bytes32,uint256)"(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, lockId?: null): LockByPartitionReleasedEventFilter;
        LockByPartitionReleased(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, lockId?: null): LockByPartitionReleasedEventFilter;
        "LockedByPartition(address,address,bytes32,uint256,uint256,uint256)"(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, lockId?: null, amount?: null, expirationTimestamp?: null): LockedByPartitionEventFilter;
        LockedByPartition(operator?: string | null, tokenHolder?: string | null, partition?: BytesLike | null, lockId?: null, amount?: null, expirationTimestamp?: null): LockedByPartitionEventFilter;
    ...
    estimateGas: {
        getLockCountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getLockCountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getLockFor(_tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getLockForByPartition(_partition: BytesLike, _tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getLockedAmountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getLockedAmountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<BigNumber>;
        getLocksIdFor(_tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getLocksIdForByPartition(_partition: BytesLike, _tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        getLockCountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLockCountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLockFor(_tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLockForByPartition(_partition: BytesLike, _tokenHolder: string, _lockId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLockedAmountFor(_tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLockedAmountForByPartition(_partition: BytesLike, _tokenHolder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLocksIdFor(_tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getLocksIdForByPartition(_partition: BytesLike, _tokenHolder: string, _pageIndex: BigNumberish, _pageLength: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
