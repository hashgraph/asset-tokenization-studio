...
export interface BusinessLogicResolver extends BaseContract {
    ...
    estimateGas: {
        ...
        checkResolverProxyConfigurationRegistered(_configurationId: BytesLike, _version: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        createBatchConfiguration(_configurationId: BytesLike, _facetConfigurations: IDiamondCutManager.FacetConfigurationStruct[], _isLastBatch: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        createConfiguration(_configurationId: BytesLike, _facetConfigurations: IDiamondCutManager.FacetConfigurationStruct[], overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        checkResolverProxyConfigurationRegistered(_configurationId: BytesLike, _version: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        createBatchConfiguration(_configurationId: BytesLike, _facetConfigurations: IDiamondCutManager.FacetConfigurationStruct[], _isLastBatch: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        createConfiguration(_configurationId: BytesLike, _facetConfigurations: IDiamondCutManager.FacetConfigurationStruct[], overrides?: Overrides & {
