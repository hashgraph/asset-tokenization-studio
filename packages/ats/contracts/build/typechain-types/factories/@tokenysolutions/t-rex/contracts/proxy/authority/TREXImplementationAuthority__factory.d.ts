...
export declare class TREXImplementationAuthority__factory extends ContractFactory {
    ...
    deploy(referenceStatus: boolean, trexFactory: string, iaFactory: string, overrides?: Overrides & {
        from?: string;
    }): Promise<TREXImplementationAuthority>;
    getDeployTransaction(referenceStatus: boolean, trexFactory: string, iaFactory: string, overrides?: Overrides & {
        from?: string;
    }): TransactionRequest;
