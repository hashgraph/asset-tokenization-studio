...
exports.RegulationSubType = exports.RegulationType = exports.SecurityType = exports.DividendType = void 0;
exports.setFactoryRegulationData = setFactoryRegulationData;
exports.setEquityData = setEquityData;
exports.setBondData = setBondData;
exports.deployEquityFromFactory = deployEquityFromFactory;
exports.deployBondFromFactory = deployBondFromFactory;
const hardhat_1 = require("hardhat");
const constants_1 = require("./constants");
var DividendType;
(function (DividendType) {
    DividendType[DividendType["NONE"] = 0] = "NONE";
    DividendType[DividendType["PREFERRED"] = 1] = "PREFERRED";
    DividendType[DividendType["COMMON"] = 2] = "COMMON";
})(DividendType || (exports.DividendType = DividendType = {}));
var SecurityType;
(function (SecurityType) {
    SecurityType[SecurityType["BOND"] = 0] = "BOND";
    SecurityType[SecurityType["EQUITY"] = 1] = "EQUITY";
})(SecurityType || (exports.SecurityType = SecurityType = {}));
exports.RegulationType = {
    NONE: 0,
    REG_S: 1,
    REG_D: 2,
};
exports.RegulationSubType = {
    NONE: 0,
    REG_D_506_B: 1,
    REG_D_506_C: 2,
};
async function setFactoryRegulationData(regulationType, regulationSubType, countriesControlListType, listOfCountries, info) {
...
async function setEquityData({ adminAccount, isWhiteList, isControllable, isMultiPartition, arePartitionsProtected, clearingActive, internalKycActivated, name, symbol, decimals, isin, votingRight, informationRight, liquidationRight, subscriptionRight, conversionRight, redemptionRight, putRight, dividendRight, currency, numberOfShares, nominalValue, init_rbacs, addAdmin = true, businessLogicResolver, externalPauses, externalControlLists, externalKycLists, compliance, identityRegistry, }) {
    ...
    const resolverProxyConfiguration = {
        key: constants_1.EQUITY_CONFIG_ID,
        version: 1,
    };
    const erc20MetadataInfo = {
        name,
        symbol,
        isin,
        decimals,
    ...
    const security = {
        ...
        compliance: compliance ?? constants_1.ADDRESS_ZERO,
        identityRegistry: identityRegistry ?? constants_1.ADDRESS_ZERO,
    };
    const equityDetails = {
...
async function setBondData({ adminAccount, isWhiteList, isControllable, isMultiPartition, arePartitionsProtected, clearingActive, internalKycActivated, name, symbol, decimals, isin, currency, numberOfUnits, nominalValue, startingDate, maturityDate, couponFrequency, couponRate, firstCouponDate, init_rbacs, addAdmin = true, businessLogicResolver, externalPauses, externalControlLists, externalKycLists, compliance, identityRegistry, }) {
    ...
    const resolverProxyConfiguration = {
        key: constants_1.BOND_CONFIG_ID,
        version: 1,
    };
    const erc20MetadataInfo = {
        name,
...
async function deployEquityFromFactory({ adminAccount, isWhiteList, isControllable, isMultiPartition, arePartitionsProtected, clearingActive, internalKycActivated, compliance, identityRegistry, name, symbol, decimals, isin, votingRight, informationRight, liquidationRight, subscriptionRight, conversionRight, redemptionRight, putRight, dividendRight, currency, numberOfShares, nominalValue, regulationType, regulationSubType, countriesControlListType, listOfCountries, info, init_rbacs, addAdmin = true, businessLogicResolver, factory, }) {
    ...
    const factoryRegulationData = await setFactoryRegulationData(regulationType, regulationSubType, countriesControlListType, listOfCountries, info);
    const result = await factory.deployEquity(equityData, factoryRegulationData, {
        gasLimit: constants_1.GAS_LIMIT.high,
    });
    const events = (await result.wait()).events;
    const deployedEquityEvent = events.find((e) => e.event == constants_1.EVENTS.equity.deployed);
    const equityAddress = deployedEquityEvent.args.equityAddress;
    return await hardhat_1.ethers.getContractAt('Equity', equityAddress);
}
async function deployBondFromFactory({ adminAccount, isWhiteList, isControllable, isMultiPartition, arePartitionsProtected, clearingActive, internalKycActivated, name, symbol, decimals, isin, currency, numberOfUnits, nominalValue, startingDate, maturityDate, couponFrequency, couponRate, firstCouponDate, regulationType, regulationSubType, countriesControlListType, listOfCountries, info, init_rbacs, addAdmin = true, factory, businessLogicResolver, compliance, identityRegistry, }) {
    ...
    const result = await factory.deployBond(bondData, factoryRegulationData, {
        gasLimit: constants_1.GAS_LIMIT.max,
    });
    const events = (await result.wait()).events;
    const deployedBondEvent = events.find((e) => e.event == constants_1.EVENTS.bond.deployed);
    const bondAddress = deployedBondEvent.args.bondAddress;
    return await hardhat_1.ethers.getContractAt('Bond', bondAddress);
}
