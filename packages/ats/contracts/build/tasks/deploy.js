...
(0, config_1.task)('deployAll', 'Deploy new factory, new facet implementation, new resolver and initialize it with the new facet implementations')
    ...
    const { factory, businessLogicResolver, accessControl, cap, controlList, kyc, ssiManagement, pause, erc20, erc1410ReadFacet, erc1410ManagementFacet, erc1410TokenHolderFacet, erc1594, erc1643, erc1644, snapshots, diamondFacet, equityUsa, bondUsa, scheduledSnapshots, scheduledBalanceAdjustments, scheduledTasks, corporateActions, lock, holdReadFacet, holdManagementFacet, holdTokenHolderFacet, transferAndLock, adjustBalances, clearingActionsFacet, clearingTransferFacet, clearingRedeemFacet, clearingHoldCreationFacet, clearingReadFacet, externalPauseManagement, externalControlListManagement, externalKycListManagement, protectedPartitions, erc3643Facet, erc3643BatchFacet, freeze, erc20Permit, } = await deployAtsFullInfrastructure(new DeployAtsFullInfrastructureCommand({
        signer: signer,
