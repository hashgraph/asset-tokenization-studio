...
export interface TREXImplementationAuthority extends BaseContract {
  ...
  filters: {
    ...
    "TREXVersionAdded((uint8,uint8,uint8),(address,address,address,address,address,address))"(
    ...
    "TREXVersionFetched((uint8,uint8,uint8),(address,address,address,address,address,address))"(
      version?: ITREXImplementationAuthority.VersionStruct | null,
      trex?: ITREXImplementationAuthority.TREXContractsStruct | null
    ...
    "VersionUpdated((uint8,uint8,uint8))"(
      version?: ITREXImplementationAuthority.VersionStruct | null
