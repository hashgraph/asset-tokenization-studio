...
export declare namespace IBond {
  ...
  export type RegisteredCouponStructOutput = [
    ...
    BigNumber
  ] & { coupon: IBond.CouponStructOutput; snapshotId: BigNumber };
...
export interface BondUSA extends BaseContract {
  ...
  functions: {
    _initialize_bondUSA(
      _bondDetailsData: IBond.BondDetailsDataStruct,
      _couponDetailsData: IBond.CouponDetailsDataStruct,
    ...
    setCoupon(
      _newCoupon: IBond.CouponStruct,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    updateMaturityDate(
      _newMaturityDate: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  };
  ...
  getBondDetails(
    overrides?: CallOverrides
  ): Promise<IBond.BondDetailsDataStructOutput>;

  getCoupon(
    _couponID: BigNumberish,
    overrides?: CallOverrides
  ): Promise<IBond.RegisteredCouponStructOutput>;

  getCouponCount(overrides?: CallOverrides): Promise<BigNumber>;

  getCouponDetails(
    overrides?: CallOverrides
  ): Promise<IBond.CouponDetailsDataStructOutput>;

  getCouponFor(
    _couponID: BigNumberish,
    _account: string,
    overrides?: CallOverrides
  ): Promise<IBond.CouponForStructOutput>;
  ...
  filters: {
    ...
    "MaturityDateUpdated(address,uint256,uint256)"(
      bondId?: string | null,
      maturityDate?: BigNumberish | null,
      previousMaturityDate?: BigNumberish | null
