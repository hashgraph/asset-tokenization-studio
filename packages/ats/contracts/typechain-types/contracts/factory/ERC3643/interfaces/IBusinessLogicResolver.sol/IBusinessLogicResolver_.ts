...
export interface IBusinessLogicResolver_Interface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, IDiamondCutManager_.FacetConfigurationStruct[], boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "createConfiguration",
    values: [BytesLike, IDiamondCutManager_.FacetConfigurationStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IBusinessLogicResolver_.BusinessLogicRegistryDataStruct[]]
  ): string;
  encodeFunctionData(
...
export type BusinessLogicsRegisteredEvent = TypedEvent<
  [IBusinessLogicResolver_.BusinessLogicRegistryDataStructOutput[], BigNumber],
...
export type DiamondConfigurationCreatedEvent = TypedEvent<
  [string, IDiamondCutManager_.FacetConfigurationStructOutput[], BigNumber],
...
export interface IBusinessLogicResolver_ extends BaseContract {
  ...
  functions: {
    ...
    createBatchConfiguration(
      _configurationId: BytesLike,
      _facetConfigurations: IDiamondCutManager_.FacetConfigurationStruct[],
      _isLastBatch: boolean,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    registerBusinessLogics(
      _businessLogics: IBusinessLogicResolver_.BusinessLogicRegistryDataStruct[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  getFacetByConfigurationIdVersionAndFacetId(
    ...
    _facetId: BytesLike,
    overrides?: CallOverrides
  ): Promise<IDiamondLoupe_.FacetStructOutput>;
