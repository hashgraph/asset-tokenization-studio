...
export interface IFactory_Interface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [IFactory_.BondDataStruct, FactoryRegulationDataStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "deployEquity",
    values: [IFactory_.EquityDataStruct, FactoryRegulationDataStruct]
  ): string;
  encodeFunctionData(
...
export interface IFactory_ extends BaseContract {
  ...
  functions: {
    deployBond(
      _bondData: IFactory_.BondDataStruct,
      _factoryRegulationData: FactoryRegulationDataStruct,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    deployEquity(
      _equityData: IFactory_.EquityDataStruct,
      _factoryRegulationData: FactoryRegulationDataStruct,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    getAppliedRegulationData(
      _regulationType: BigNumberish,
      _regulationSubType: BigNumberish,
  ...
  filters: {
    "BondDeployed(address,address,((bool,bool,address,(bytes32,uint256),(bytes32,address[])[],bool,bool,uint256,(string,string,string,uint8),bool,bool,address[],address[],address[],address,address),(bytes3,uint256,uint256,uint256),(uint256,uint256,uint256)),(uint8,uint8,(bool,string,string)))"(
    ...
    "EquityDeployed(address,address,((bool,bool,address,(bytes32,uint256),(bytes32,address[])[],bool,bool,uint256,(string,string,string,uint8),bool,bool,address[],address[],address[],address,address),(bool,bool,bool,bool,bool,bool,bool,uint8,bytes3,uint256)),(uint8,uint8,(bool,string,string)))"(
      deployer?: string | null,
      equityAddress?: null,
      equityData?: null,
      regulationData?: null
