...
import type {
  ...
  IBusinessLogicResolver_Interface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IBusinessLogicResolver.sol/IBusinessLogicResolver_";
...
const _abi = [
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType:
          "struct IBusinessLogicResolver_.BusinessLogicRegistryData[]",
        name: "businessLogics",
        type: "tuple[]",
      },
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct IDiamondCutManager_.FacetConfiguration[]",
    ...
    outputs: [
      {
        ...
        internalType: "struct IDiamondLoupe_.Facet",
        name: "facet_",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum IBusinessLogicResolver_.VersionStatus",
        name: "status_",
        type: "uint8",
      },
    ],
...
export class IBusinessLogicResolver___factory {
  static readonly abi = _abi;
  static createInterface(): IBusinessLogicResolver_Interface {
    return new utils.Interface(_abi) as IBusinessLogicResolver_Interface;
  }
  static connect(
    address: string,
