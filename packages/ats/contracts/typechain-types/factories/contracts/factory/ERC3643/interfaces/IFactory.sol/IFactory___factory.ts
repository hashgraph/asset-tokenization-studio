...
import type {
  IFactory_,
  IFactory_Interface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IFactory.sol/IFactory_";
...
export class IFactory___factory {
  static readonly abi = _abi;
  static createInterface(): IFactory_Interface {
    return new utils.Interface(_abi) as IFactory_Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IFactory_ {
    return new Contract(address, _abi, signerOrProvider) as IFactory_;
  }
}
