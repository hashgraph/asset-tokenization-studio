...
import type {
  IDiamondLoupe_,
  IDiamondLoupe_Interface,
} from "../../../../../../contracts/factory/ERC3643/interfaces/IDiamondLoupe.sol/IDiamondLoupe_";
...
export class IDiamondLoupe___factory {
  static readonly abi = _abi;
  static createInterface(): IDiamondLoupe_Interface {
    return new utils.Interface(_abi) as IDiamondLoupe_Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDiamondLoupe_ {
    return new Contract(address, _abi, signerOrProvider) as IDiamondLoupe_;
  }
}
