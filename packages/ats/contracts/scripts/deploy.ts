...
export async function deployAtsContracts({
  ...
  const commands = {
    ...
    accessControlFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.AccessControlFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    ssiManagementFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.SsiManagementFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    holdTokenHolderFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.HoldTokenHolderFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    erc1410ManagementFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ERC1410ManagementFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    erc1410TokenHolderFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ERC1410TokenHolderFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    scheduledSnapshotsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ScheduledSnapshotsFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    scheduledBalanceAdjustmentsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ScheduledBalanceAdjustmentsFacet.addresses?.[
            network
          ]
        : undefined,
      overrides,
    ...
    scheduledTasksFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ScheduledTasksFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    corporateActionsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.CorporateActionsFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    transferAndLockFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.TransferAndLockFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    adjustBalancesFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.AdjustBalancesFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    protectedPartitionsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ProtectedPartitionsFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    clearingTransferFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ClearingTransferFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    clearingRedeemFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ClearingRedeemFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    clearingHoldCreationFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ClearingHoldCreationFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    clearingActionsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ClearingActionsFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    externalPauseManagementFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ExternalPauseManagementFacet.addresses?.[
            network
          ]
        : undefined,
      overrides,
    }),
    externalControlListManagementFacet: new DeployContractWithFactoryCommand({
      factory: getFactory(
    ...
    externalKycListManagementFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ExternalKycListManagementFacet.addresses?.[
            network
          ]
        : undefined,
      overrides,
    ...
    erc3643ManagementFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ERC3643ManagementFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    erc3643OperationsFacet: new DeployContractWithFactoryCommand({
      ...
      signer,
      deployedContract: useDeployed
        ? Configuration.contracts.ERC3643OperationsFacet.addresses?.[network]
        : undefined,
      overrides,
    }),
    ...
    timeTravel:
      timeTravelEnabled == true
        ? new DeployContractWithFactoryCommand({
            ...
            signer,
            deployedContract: useDeployed
              ? Configuration.contracts.TimeTravel.addresses?.[network]
              : undefined,
            overrides,
          })
        : undefined,
  ...
  const deployedContracts: DeployAtsContractsResult =
    new DeployAtsContractsResult({
      ...
      pauseFacet: await deployContractWithFactory(commands.pauseFacet).then(
        (result) => {
          console.log(
      ...
      erc20Facet: await deployContractWithFactory(commands.erc20Facet).then(
        (result) => {
          console.log(
      ...
      erc1594Facet: await deployContractWithFactory(commands.erc1594Facet).then(
        (result) => {
          console.log(
      ...
      erc1643Facet: await deployContractWithFactory(commands.erc1643Facet).then(
        (result) => {
          console.log(
      ...
      erc1644Facet: await deployContractWithFactory(commands.erc1644Facet).then(
        (result) => {
          console.log(
      ...
      erc20Votes: await deployContractWithFactory(commands.erc20Votes).then(
        (result) => {
          console.log(
      ...
      diamondFacet: await deployContractWithFactory(commands.diamondFacet).then(
        (result) => {
          console.log(
      ...
      bondUsaRead: await deployContractWithFactory(commands.bondUsaRead).then(
        (result) => {
          console.log(
      ...
      bondUsaFacet: await deployContractWithFactory(commands.bondUsaFacet).then(
        (result) => {
          console.log(
      ...
      freezeFacet: await deployContractWithFactory(commands.freezeFacet).then(
        (result) => {
          console.log(
