...
export async function deployAtsContracts({
    ...
    const commands = {
        ...
        proceedRecipients: new DeployContractWithFactoryCommand({
            factory: getFactory(
                new ProceedRecipientsFacet__factory(),
                new ProceedRecipientsFacetTimeTravel__factory()
            ),
            signer,
            deployedContract: useDeployed
                ? Configuration.contracts.ProceedRecipientsFacet.addresses?.[
                      network
                  ]
                : undefined,
            overrides,
    ...
    const deployedContracts: DeployAtsContractsResult =
        new DeployAtsContractsResult({
            ...
            proceedRecipientsFacet: await deployContractWithFactory(
                commands.proceedRecipients
            ).then((result) => {
                console.log(
                    `ProceedRecipients has been deployed successfully at ${result.address}`
                )
                return result
            }),
            ...
            erc3643ManagementFacet: await deployContractWithFactory(
                ...
                console.log(
                    `ERC3643ManagementFacet has been deployed successfully at ${result.address}`
                )
                return result
            }),
            erc3643OperationsFacet: await deployContractWithFactory(
                ...
                console.log(
                    `ERC3643OperationsFacet has been deployed successfully at ${result.address}`
                )
                return result
            }),
            erc3643ReadFacet: await deployContractWithFactory(
                ...
                console.log(
                    `ERC3643ReadFacet has been deployed successfully at ${result.address}`
                )
                return result
            }),
