 ...
 *
 * Generated: 2026-04-24T07:02:53.271Z
 * Facets: 86
 * Infrastructure: 2
 *
...
export const FACET_REGISTRY: Record<string, FacetDefinition> = {
  ...
  IControllerFacet: {
    name: "IControllerFacet",
    description: "Interface for the ControllerFacet, grouping all controller and agent management operations.",
    methods: [
      {
        name: "addAgent",
        signature: { full: "function addAgent(address _agent)", canonical: "addAgent(address)" },
      ...
      },
      {
        name: "initializeController",
        signature: {
          full: "function initializeController(bool _isControllable)",
          canonical: "initializeController(bool)",
        },
        selector: "0xcfb008c8",
      },
