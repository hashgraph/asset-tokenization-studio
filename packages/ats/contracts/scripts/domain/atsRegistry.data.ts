 ...
 *
 * Generated: 2026-04-14T06:52:55.593Z
 * Facets: 73
 * Infrastructure: 2
 *
...
export const FACET_REGISTRY: Record<string, FacetDefinition> = {
  ...
  CouponFacet: {
    ...
    resolverKey: {
      ...
      value: "0xc2edf8740de0e32f35a85924a0ff78586a26eae4b1f2e236b88cc5868ca15245",
    },
    ...
    methods: [
      ...
      },
      {
        name: "getCouponsFor",
        signature: {
          full: "function getCouponsFor(uint256 _couponID, uint256 _pageIndex, uint256 _pageLength) view returns ((uint256 tokenBalance, uint8 decimals, bool recordDateReached, (uint256 recordDate, uint256 executionDate, uint256 startDate, uint256 endDate, uint256 fixingDate, uint256 rate, uint8 rateDecimals, uint8 rateStatus) coupon, bool isDisabled)[] couponsFor_, address[] accounts_)",
