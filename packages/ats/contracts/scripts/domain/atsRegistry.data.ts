 ...
 *
 * Generated: 2026-04-20T14:00:31.710Z
 * Facets: 79
 * Infrastructure: 2
 *
...
export const FACET_REGISTRY: Record<string, FacetDefinition> = {
  ...
  CoreFacet: {
    name: "CoreFacet",
    description: "Facet shell exposing Core functionality via Diamond proxy pattern",
    resolverKey: {
    ...
    methods: [
      ...
      },
      {
        name: "initializeCore",
        signature: {
          full: "function initializeCore(((string name, string symbol, string isin, uint8 decimals) info, uint8 securityType) erc20Metadata)",
