 ...
 * Includes all common facets plus CoreFacet, EquityUSAFacet, VotingFacet, and DividendFacet.
 *
 ...
 */
const EQUITY_FACETS = [
  // Core Functionality (11 - DiamondFacet combines DiamondCutFacet + DiamondLoupeFacet)
  "AccessControlFacet",
  "CoreFacet",
  "CapFacet",
  "ControlListFacet",
