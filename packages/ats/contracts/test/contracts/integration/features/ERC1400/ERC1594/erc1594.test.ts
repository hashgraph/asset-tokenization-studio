...
describe("ERC1594 Tests", () => {
  ...
  describe("Multi partition mode", () => {
    async function deploySecurityFixtureMultiPartition() {
      ...
      accessControlFacet = (await ethers.getContractAt("IAccessControl", diamond.target)) as IAccessControl;
      ...
      controlList = (await ethers.getContractAt("IControlList", diamond.target)) as ControlList;
      ...
      accessControlFacet = accessControlFacet.connect(signer_A) as IAccessControl;
    ...
    describe("ControlList", () => {
      ...
      it("GIVEN blocked accounts (to) USING WHITELIST WHEN issue THEN transaction fails with AccountIsBlocked", async () => {
        ...
        const newAccessControl = accessControlFacet
          ...
          .connect(signer_A) as IAccessControl;
