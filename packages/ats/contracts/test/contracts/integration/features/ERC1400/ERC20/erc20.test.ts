...
describe("ERC20 Tests", () => {
  ...
  describe("Multi partition", () => {
    async function deploySecurityFixtureMultiPartition() {
      ...
      pauseFacet = await ethers.getContractAt("IPause", diamond.target, signer_B);
      controlListFacet = await ethers.getContractAt("IControlList", diamond.target, signer_A);
  ...
  describe("Single partition", () => {
    ...
    async function deploySecurityFixtureSinglePartition() {
      ...
      erc1594Facet = await ethers.getContractAt("IERC1594", diamond.target, signer_B);
    ...
    describe("Protected Partitions Role Tests", () => {
      ...
      beforeEach(async () => {
        protectedPartitionsFacet = await ethers.getContractAt("IProtectedPartitions", diamond.target);
