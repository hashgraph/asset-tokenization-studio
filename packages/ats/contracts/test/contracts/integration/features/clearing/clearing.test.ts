...
describe("Clearing Tests", () => {
  ...
  async function setFacets({ diamond }: { diamond: ResolverProxy }) {
    ...
    equityFacet = await ethers.getContractAt("IEquityUSA", diamond.target, signer_A);
    accessControlFacet = await ethers.getContractAt("AccessControlFacet", diamond.target, signer_A);
    adjustBalancesFacet = await ethers.getContractAt("IAdjustBalances", diamond.target, signer_A);
    pauseFacet = await ethers.getContractAt("IPause", diamond.target, signer_D);
    ...
    kycFacet = await ethers.getContractAt("IKyc", diamond.target, signer_B);
    ssiManagementFacet = await ethers.getContractAt("ISsiManagement", diamond.target, signer_A);
    snapshotFacet = await ethers.getContractAt("ISnapshots", diamond.target);
    ...
    protectedPartitionsFacet = await ethers.getContractAt("IProtectedPartitions", diamond.target, signer_A);
  ...
  describe("Common Modifiers", () => {
    ...
    describe("onlyUnProtectedPartitionsOrWildCardRole modifier", () => {
      beforeEach(async () => {
        ...
        // Protect partitions
        protectedPartitionsFacet = await ethers.getContractAt("IProtectedPartitions", diamond.target.toString());
