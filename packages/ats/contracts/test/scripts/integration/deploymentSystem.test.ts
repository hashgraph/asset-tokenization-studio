...
describe("Phase 1 Deployment System - Integration Tests", () => {
  ...
  describe("Utilities - Naming", () => {
    it("should detect if contract name is TimeTravelFacet", () => {
      expect(isTimeTravelFacet("TimeTravelFacet")).to.be.true;
      expect(isTimeTravelFacet("AccessControlFacet")).to.be.false;
      expect(isTimeTravelFacet("AccessControlFacetTimeTravel")).to.be.false;
      expect(isTimeTravelFacet("ProxyAdmin")).to.be.false;
    });
  });
