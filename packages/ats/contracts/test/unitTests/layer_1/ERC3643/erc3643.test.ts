...
describe('ERC3643 Tests', () => {
  ...
  describe('single partition', () => {
    ...
    beforeEach(async () => {
      ...
      holdFacet = await ethers.getContractAt('Hold', diamond.address, signer_A);
    ...
    describe('mint', () => {
      ...
      it('GIVEN blocked account USING WHITELIST WHEN mint THEN transaction fails with AccountIsBlocked', async () => {
        ...
        ).to.be.revertedWithCustomError(erc3643Facet, 'AccountIsBlocked');
      });
    ...
    describe('Batch Operations', () => {
      ...
      describe('batchTransfer', () => {
        ...
        it('GIVEN insufficient balance WHEN batchTransfer THEN transaction fails', async () => {
          ...
          ).to.be.revertedWithCustomError(erc3643Facet, 'InvalidPartition');
        });
      ...
      describe('batchSetAddressFrozen', () => {
        ...
        it('GIVEN an account without FREEZE_MANAGER_ROLE WHEN batchSetAddressFrozen THEN transaction fails', async () => {
          ...
          await expect(
            freezeFacet.batchSetAddressFrozen(userAddresses, freezeFlags),
          ).to.be.revertedWithCustomError(erc3643Facet, 'AccountHasNoRoles');
        });
    ...
    describe('AccessControl', () => {
      ...
      it('GIVEN an account without admin role WHEN setCompliance THEN transaction fails with AccountHasNoRole', async () => {
        ...
        await expect(erc3643Facet.setCompliance(compliance)).to.be.rejectedWith(
          'AccountHasNoRole',
        );
      });
    ...
    describe('Recovery', () => {
      ...
      it('GIVEN a recovered address THEN operations should fail', async () => {
        ...
        expect(canTransfer[1]).to.equal(ADDRESS_RECOVERED_OPERATOR_ERROR_ID);
        // 2 - From
        await erc1410Facet.issueByPartition({
          partition: DEFAULT_PARTITION,
          tokenHolder: account_A,
