...
describe('Snapshots Tests', () => {
  ...
  it('GIVEN an account with snapshot role WHEN takeSnapshot THEN transaction succeeds', async () => {
    ...
    const snapshot_TotalSupply_1_Partition_1 =
      await snapshotFacet.totalSupplyAtSnapshotByPartition(_PARTITION_ID_1, 1);
    const snapshot_TotalSupply_1_Partition_2 =
      await snapshotFacet.totalSupplyAtSnapshotByPartition(_PARTITION_ID_2, 1);
    ...
    const snapshot_TotalSupply_2_Partition_1 =
      await snapshotFacet.totalSupplyAtSnapshotByPartition(_PARTITION_ID_1, 2);
    const snapshot_TotalSupply_2_Partition_2 =
      await snapshotFacet.totalSupplyAtSnapshotByPartition(_PARTITION_ID_2, 2);
