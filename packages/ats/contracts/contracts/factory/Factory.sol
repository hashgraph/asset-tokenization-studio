...
import { IFactoryEquityBond } from "./IFactory.sol";
 ...
 */
abstract contract Factory is FactoryCommon, IFactoryEquityBond {
    /**
    ...
    ) external override onlyValidResolver(_resolver) onlyValidAdmins(_rbacs) returns (address proxyAddress_) {
