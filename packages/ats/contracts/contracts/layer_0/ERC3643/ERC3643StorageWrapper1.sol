...
abstract contract ERC3643StorageWrapper1 is IERC3643StorageWrapper, PauseStorageWrapper {
    ...
    function _initialize_ERC3643(address _compliance, address _identityRegistry) internal {
        IERC3643Basic.ERC3643Storage storage clearingStorage = _erc3643Storage();
    ...
    function _erc3643Storage() internal pure returns (IERC3643Basic.ERC3643Storage storage erc3643Storage_) {
