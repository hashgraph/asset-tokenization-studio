...
library LibClearing {
    ...
    function setClearingTransferDataStruct(
        ...
        cs.clearingIdsByAccountAndPartitionAndTypes[_tokenHolder][_partition][IClearing.ClearingOperationType.Transfer].add(_clearingId);
    }
    ...
    function setClearingRedeemDataStruct(
        ...
        cs.clearingIdsByAccountAndPartitionAndTypes[_tokenHolder][_partition][IClearing.ClearingOperationType.Redeem].add(_clearingId);
    }
    ...
    function setClearingHoldCreationDataStruct(
        ...
        cs.clearingIdsByAccountAndPartitionAndTypes[_tokenHolder][_partition][IClearing.ClearingOperationType.HoldCreation].add(_clearingId);
    }
    ...
    function decreaseTotalClearedAmounts(
        address _tokenHolder,
        bytes32 _partition,
        uint256 _amount
    ) internal {
    ...
    /// @param _partition The partition
    /// @param _clearingId The clearing ID
    function deleteClearingTransferData(
        address _tokenHolder,
        bytes32 _partition,
        uint256 _clearingId
    ) internal {
    ...
    /// @param _partition The partition
    /// @param _clearingId The clearing ID
    function deleteClearingRedeemData(
        address _tokenHolder,
        bytes32 _partition,
        uint256 _clearingId
    ) internal {
    ...
    /// @param _partition The partition
    /// @param _clearingId The clearing ID
    function deleteClearingHoldCreationData(
        address _tokenHolder,
        bytes32 _partition,
        uint256 _clearingId
    ) internal {
    ...
    function deleteClearingThirdParty(
        ...
        delete clearingStorage().clearingThirdPartyByAccountPartitionTypeAndId[_tokenHolder][_partition][_operationType][
            _clearingId
        ];
    }
}
