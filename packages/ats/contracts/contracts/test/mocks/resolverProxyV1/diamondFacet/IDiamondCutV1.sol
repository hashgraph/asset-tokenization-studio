...
import { IStaticFunctionSelectorsV1 } from "../IStaticFunctionSelectorsV1.sol";
...
interface IDiamondCutV1 is IStaticFunctionSelectorsV1 {
    /**
     ...
     * @return version_ Version number of the active configuration.
     */
