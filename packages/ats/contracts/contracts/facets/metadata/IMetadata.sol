...
/// @custom:hash resolverKey Metadata
bytes32 constant RESOLVER_KEY_METADATA = 0x524fd484241fdce7c81d7872ddc2c45a3d44e664fcf855587839e9c68e481c9f;
 ...
 *      `STORAGE_LOCATION_METADATA` via `MetadataStorageWrapper`. Mutations require the
 *      `ROLE_METADATA_MANAGER` and the token to be unpaused; reads are unrestricted. Each call to
