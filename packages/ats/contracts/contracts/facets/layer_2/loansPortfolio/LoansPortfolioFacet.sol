...
contract LoansPortfolioFacet is LoansPortfolio, IStaticFunctionSelectors, Common {
    ...
    function getStaticFunctionSelectors() external pure override returns (bytes4[] memory staticFunctionSelectors_) {
        ...
        staticFunctionSelectors_[selectorIndex++] = this.initialize_LoansPortfolio.selector;
