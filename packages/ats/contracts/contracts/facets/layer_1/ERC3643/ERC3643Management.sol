...
abstract contract ERC3643Management is IERC3643Management, Modifiers {
    ...
    ) external override onlyRole(DEFAULT_ADMIN_ROLE) onlyFacetNotRegistered(RESOLVER_KEY_ERC3643_MANAGEMENT) {
        ERC3643StorageWrapper.initializeERC3643(_compliance, _identityRegistry);
        InitializerStorageWrapper.setFacetToReady(RESOLVER_KEY_ERC3643_MANAGEMENT);
