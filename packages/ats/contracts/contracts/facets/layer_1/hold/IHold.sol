...
/// @notice Aggregates the per-facet Hold interfaces (IHoldRead, IHoldManagement, IHoldTokenHolder)
...
///      per-facet interface (`IHoldRead` / `IHoldManagement` / `IHoldTokenHolder`). This umbrella
...
interface IHold is IHoldTypes, IHoldRead, IHoldManagement, IHoldTokenHolder {}
