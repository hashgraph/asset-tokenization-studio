...
/// @notice Aggregates the per-facet Hold interfaces (IHoldRead, IHoldManagement, IHoldByPartition)
...
///      per-facet interface (`IHoldRead` / `IHoldManagement` / `IHoldByPartition`). This umbrella
...
interface IHold is IHoldTypes, IHoldRead, IHoldManagement, IHoldByPartition {}
