...
abstract contract ERC1594FacetBase is
    IERC1594,
    ...
    IERC1644StorageWrapper
{
    ...
    function transferWithData(address _to, uint256 _value, bytes calldata _data) external override {
        ...
        LibTokenTransfer.transfer(msg.sender, _to, _value, _getBlockTimestamp());
    ...
    function transferFromWithData(address _from, address _to, uint256 _value, bytes calldata _data) external override {
        ...
        LibTokenTransfer.transferFrom(msg.sender, _from, _to, _value, _getBlockTimestamp());
    ...
    function issue(address _tokenHolder, uint256 _value, bytes calldata _data) external override {
        ...
        LibTokenTransfer.mint(_tokenHolder, _value, _getBlockTimestamp());
        emit IERC1594StorageWrapper.Issued(msg.sender, _tokenHolder, _value, _data);
    }
    ...
    function redeem(uint256 _value, bytes memory _data) external override {
        ...
        LibTokenTransfer.burn(msg.sender, _value, _getBlockTimestamp());
        emit IERC1594StorageWrapper.Redeemed(address(0), msg.sender, _value, _data);
    }
    ...
    function redeemFrom(address _tokenHolder, uint256 _value, bytes memory _data) external override {
        ...
        emit IERC1594StorageWrapper.Redeemed(msg.sender, _tokenHolder, _value, _data);
    }
