...
import { ScheduledTask, ScheduledTasksDataStorage } from "../../facets/assets/scheduledTasks/IScheduledTasksCommon.sol";

library LibScheduledTasksStorage {
    ...
    function getScheduledTasks(
        ...
        scheduledTask_ = new ScheduledTask[](LibPagination.getSize(start, end, getScheduledTaskCount(_scheduledTasks)));
