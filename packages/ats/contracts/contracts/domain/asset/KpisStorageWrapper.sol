...
library KpisStorageWrapper {
    ...
    function addKpiData(uint256 _date, uint256 _value, address _project) internal {
        ...
        Checkpoints.Checkpoint[] storage ckpt = kpis.checkpointsByProject[_project];
    ...
    function pushKpiData(Checkpoints.Checkpoint[] storage _ckpt, uint256 _date, uint256 _value) internal {
