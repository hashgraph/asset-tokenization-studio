...
library ERC20VotesStorageWrapper {
    ...
    function takeAbafCheckpoint(uint256 currentAbaf, uint256 currentBlockNumber) internal {
        ...
        votes.abafCheckpoints.push(Checkpoints.Checkpoint({ from: currentBlockNumber, value: currentAbaf }));
    }
    ...
    function getCheckpoint(address account, uint256 pos) internal view returns (Checkpoints.Checkpoint memory) {
    ...
    function _writeCheckpoint(
        ...
        unchecked {
            ...
            if (pos > 0 && oldCkpt.from == currentBlockNumber) {
                ...
                ckpts.push(Checkpoints.Checkpoint({ from: currentBlockNumber, value: newWeight }));
            }
        }
    }
