...
abstract contract LoanStorageWrapper is BondStorageWrapper {
    ...
    function _initialize_loan(ILoan.LoanDetailsData calldata _loanDetailsData) internal override {
        LoanDataStorage storage ls = _loanStorage();
        ls.initialized = true;
        _writeLoanDetails(_loanDetailsData, ls);
    }

    function _setLoanDetails(ILoan.LoanDetailsData memory _loanDetails) internal override {
