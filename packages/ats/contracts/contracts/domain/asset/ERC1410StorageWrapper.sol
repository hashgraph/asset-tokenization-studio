...
import { BasicTransferInfo } from "../../facets/core/ERC1400/ERC1410/IERC1410Types.sol";
...
library ERC1410StorageWrapper {
    ...
    function addPartitionTo(uint256 _value, address _to, bytes32 _partition) internal {
        ABAFStorageWrapper.pushLabafUserPartition(_to, ABAFStorageWrapper.getAbaf());
    ...
    // ═══════════════════════════════════════════════════════════════════════════════
    // LOW-LEVEL PRIMITIVES — state-modifying (for ABAFStorageWrapper balance adjustment)
    // ═══════════════════════════════════════════════════════════════════════════════
    ...
    /// @dev Only for use by ABAFStorageWrapper.addPartitionToWithLabaf. For normal usage, use addPartitionTo.
    ...
    // ═══════════════════════════════════════════════════════════════════════════════
    // LOW-LEVEL PRIMITIVES — view/pure (for ABAFStorageWrapper balance adjustment)
    // ═══════════════════════════════════════════════════════════════════════════════
    ...
    function erc1410BasicStorage() internal pure returns (ERC1410BasicStorage storage erc1410Basic_) {
    ...
    function erc1410OperatorStorage() internal pure returns (ERC1410OperatorStorage storage erc1410Operator_) {
