...
/// @dev Generic external-list layout. The `externalListStorage(bytes32 _position)` accessor
///      instantiates this struct at FOUR independent ERC-7201 namespaces, one per consumer:
