...
import GetNonceRequest from "@port/in/request/security/operations/protectedPartitions/GetNonceRequest";
...
export const GetNonceQueryFixture = createFixture<GetNonceQuery>((query) => {
  query.securityId.as(() => HederaIdPropsFixture.create().value);
  query.targetId.as(() => HederaIdPropsFixture.create().value);
});
export const GetNonceRequestFixture = createFixture<GetNonceRequest>((request) => {
  request.securityId.as(() => HederaIdPropsFixture.create().value);
  request.targetId.as(() => HederaIdPropsFixture.create().value);
});
