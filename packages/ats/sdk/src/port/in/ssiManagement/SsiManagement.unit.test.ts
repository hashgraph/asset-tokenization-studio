...
describe('Ssi Management', () => {
  ...
  describe('addIssuer', () => {
    ...
    it('should  add issuer successfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new AddIssuerCommand(
          addIssuerRequest.securityId,
          addIssuerRequest.issuerId,
        ),
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(SsiManagement.addIssuer(addIssuerRequest)).rejects.toThrow(
  ...
  describe('setRevocationRegistryAddress', () => {
    ...
    it('should set revocation registry successfully', async () => {
      ...
      const result = await SsiManagement.setRevocationRegistryAddress(
        setRevocationRegistryAddressRequest,
      );
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        SsiManagement.setRevocationRegistryAddress(
          setRevocationRegistryAddressRequest,
        ),
  ...
  describe('removeIssuer', () => {
    ...
    it('should remove issuer successfully', async () => {
      ...
      expect(commandBusMock.execute).toHaveBeenCalledWith(
        new RemoveIssuerCommand(
          removeIssuerRequest.securityId,
          removeIssuerRequest.issuerId,
        ),
      );
      expect(result).toEqual(expectedResponse);
    });
    ...
    it('should throw an error if command execution fails', async () => {
      ...
      await expect(
        SsiManagement.removeIssuer(removeIssuerRequest),
      ).rejects.toThrow('Command execution failed');
  ...
  describe('getRevocationRegistryAddress', () => {
    ...
    it('should get revocation registry successfully', async () => {
      ...
      const result = await SsiManagement.getRevocationRegistryAddress(
        getRevocationRegistryAddressRequest,
      );
      ...
      expect(queryBusMock.execute).toHaveBeenCalledWith(
        new GetRevocationRegistryAddressQuery(
          getRevocationRegistryAddressRequest.securityId,
        ),
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        SsiManagement.getRevocationRegistryAddress(
          getRevocationRegistryAddressRequest,
        ),
  ...
  describe('getIssuerListCount', () => {
    ...
    it('should get revocation registry successfully', async () => {
      ...
      const result = await SsiManagement.getIssuerListCount(
        getIssuerListCountRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        SsiManagement.getIssuerListCount(getIssuerListCountRequest),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('getIssuerListMembers', () => {
    ...
    it('should get issuer list members successfully', async () => {
      ...
      const result = await SsiManagement.getIssuerListMembers(
        getIssuerListMembersRequest,
      );
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(
        SsiManagement.getIssuerListMembers(getIssuerListMembersRequest),
      ).rejects.toThrow('Query execution failed');
  ...
  describe('isIssuer', () => {
    ...
    it('should throw an error if query execution fails', async () => {
      ...
      await expect(SsiManagement.isIssuer(isIssuerRequest)).rejects.toThrow(
