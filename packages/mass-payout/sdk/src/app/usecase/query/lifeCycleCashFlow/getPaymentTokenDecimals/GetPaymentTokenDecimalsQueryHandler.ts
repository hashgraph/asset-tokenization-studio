...
} from './GetPaymentTokenDecimalsQuery';
...
export class GetPaymentTokenDecimalsQueryHandler
  implements IQueryHandler<GetPaymentTokenDecimalsQuery>
{
  constructor(
  ...
  async execute(
    query: GetPaymentTokenDecimalsQuery,
  ): Promise<GetPaymentTokenDecimalsQueryResponse> {
    try {
      ...
      const res = await this.queryAdapter.getPaymentTokenDecimals(
