...
export class GetPaymentTokenQueryHandler
  implements IQueryHandler<GetPaymentTokenQuery>
{
  constructor(
  ...
  ): Promise<GetPaymentTokenQueryResponse> {
    try {
      ...
      const res = await this.queryAdapter.getPaymentToken(
