...
export class ExecuteDistributionCommandHandler
  implements ICommandHandler<ExecuteDistributionCommand>
{
  constructor(
  ...
  async execute(
    command: ExecuteDistributionCommand,
  ): Promise<ExecuteDistributionCommandResponse> {
    try {
      const {
        lifeCycleCashFlowId,
        asset,
