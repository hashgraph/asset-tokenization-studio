...
describe('ExecuteAmountSnapshotByAddressesCommandHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new ExecuteAmountSnapshotByAddressesCommandHandler(
      transactionService,
      contractService,
    );
  });
  ...
  it('should execute successfully and return response', async () => {
    ...
    transactionHandlerMock.executeAmountSnapshotByAddresses.mockResolvedValue(
      mockedRes,
    );
    ...
    expect(
      transactionHandlerMock.executeAmountSnapshotByAddresses,
  ...
  it('should throw ExecuteAmountSnapshotByAddressesCommandError when something fails', async () => {
    ...
    await expect(handler.execute(command)).rejects.toThrow(
      ExecuteAmountSnapshotByAddressesCommandError,
    );
  });
});
