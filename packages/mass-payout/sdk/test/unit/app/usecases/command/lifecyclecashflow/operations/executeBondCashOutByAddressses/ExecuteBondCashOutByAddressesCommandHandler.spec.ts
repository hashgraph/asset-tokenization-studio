...
describe('ExecuteBondCashOutByAddressesCommandHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new ExecuteBondCashOutByAddressesCommandHandler(
      transactionService,
      contractService,
    );
  });
  ...
  it('should execute successfully and return a response', async () => {
    ...
    transactionHandlerMock.executeBondCashOutByAddresses.mockResolvedValue(
      mockedRes,
    );
    ...
    expect(
      transactionHandlerMock.executeBondCashOutByAddresses,
  ...
  it('should throw ExecuteBondCashOutByAddressesCommandError on failure', async () => {
    ...
    await expect(handler.execute(command)).rejects.toThrow(
      ExecuteBondCashOutByAddressesCommandError,
    );
  });
});
