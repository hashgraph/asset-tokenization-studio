...
describe('ExecutePercentageSnapshotByAddressesCommandHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new ExecutePercentageSnapshotByAddressesCommandHandler(
      transactionService,
      contractService,
    );
  });
  ...
  it('should execute successfully and return a response', async () => {
    ...
    transactionHandlerMock.executePercentageSnapshotByAddresses.mockResolvedValue(
      mockedRes,
    );
    ...
    expect(
      transactionHandlerMock.executePercentageSnapshotByAddresses,
  ...
  it('should throw ExecutePercentageSnapshotByAddressesCommandError on failure', async () => {
    ...
    await expect(handler.execute(command)).rejects.toThrow(
      ExecutePercentageSnapshotByAddressesCommandError,
    );
  });
});
