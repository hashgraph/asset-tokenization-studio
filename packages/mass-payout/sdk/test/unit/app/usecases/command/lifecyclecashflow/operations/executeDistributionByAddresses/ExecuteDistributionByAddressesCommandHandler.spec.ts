...
describe("ExecuteDistributionByAddressesCommandHandler", () => {
  ...
  beforeEach(() => {
    ...
    handler = new ExecuteDistributionByAddressesCommandHandler(
      transactionService,
      contractService
    )
  })
  ...
  it("should execute successfully and return a response", async () => {
    ...
    transactionHandlerMock.executeDistributionByAddresses.mockResolvedValue(
      mockedRes
    )
    ...
    expect(
      transactionHandlerMock.executeDistributionByAddresses
  ...
  it("should throw ExecuteDistributionByAddressesCommandError on failure", async () => {
    ...
    await expect(handler.execute(command)).rejects.toThrow(
      ExecuteDistributionByAddressesCommandError
    )
  })
})
