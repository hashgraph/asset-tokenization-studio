...
async function createVcT3() {
  // Issuer's private key and setup
  const issuerPrivateKey = process.env.CLIENT_PRIVATE_KEY_ECDSA_1_HEX ?? '';
  const issuer = new EthrDID(issuerPrivateKey, 'polygon'); // hedera is not part of the ChainNames....
  // Holder's DID
