...
} from '@test/fixtures/erc3643/ERC3643Fixture';
import {
  FreezePartialTokensCommand,
  FreezePartialTokensResponse,
} from '@command/security/operations/erc3643/freezePartialTokens/FreezePartialTokensCommand';
import {
  UnfreezePartialTokensCommand,
  UnfreezePartialTokensResponse,
} from '@command/security/operations/erc3643/unfreezePartialTokens/UnfreezePartialTokensCommand';
