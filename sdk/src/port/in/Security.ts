...
interface ISecurityInPort {
  ...
  issue(request: IssueRequest): Promise<boolean>;
  redeem(request: RedeemRequest): Promise<boolean>;
  controllerRedeem(request: ForceRedeemRequest): Promise<boolean>;
  ...
  addToControlList(request: ControlListRequest): Promise<boolean>;
  removeFromControlList(request: ControlListRequest): Promise<boolean>;
  ...
  transfer(request: TransferRequest): Promise<boolean>;
  transferAndLock(request: TransferAndLockRequest): Promise<boolean>;
  controllerTransfer(request: ForceTransferRequest): Promise<boolean>;
  setMaxSupply(request: SetMaxSupplyRequest): Promise<boolean>;
  getMaxSupply(request: GetMaxSupplyRequest): Promise<MaxSupplyViewModel>;
  lock(request: LockRequest): Promise<boolean>;
...
class SecurityInPort implements ISecurityInPort {
  ...
  @LogError
  async lock(request: LockRequest): Promise<boolean> {
  ...
  @LogError
  async issue(request: IssueRequest): Promise<boolean> {
  ...
  @LogError
  async redeem(request: RedeemRequest): Promise<boolean> {
    const { securityId, amount } = request;
    handleValidation('RedeemRequest', request);

    return (
      await this.commandBus.execute(new RedeemCommand(amount, securityId))
    ).payload;
  }

  @LogError
  async controllerRedeem(request: ForceRedeemRequest): Promise<boolean> {
  ...
  @LogError
  async addToControlList(request: ControlListRequest): Promise<boolean> {
  ...
  @LogError
  async removeFromControlList(request: ControlListRequest): Promise<boolean> {
    const { securityId, targetId } = request;
    handleValidation('ControlListRequest', request);
  ...
  @LogError
  async transferAndLock(request: TransferAndLockRequest): Promise<boolean> {
  ...
  @LogError
  async controllerTransfer(request: ForceTransferRequest): Promise<boolean> {
  ...
  @LogError
  async setMaxSupply(request: SetMaxSupplyRequest): Promise<boolean> {
