...
export const MINT_GAS = 7000000;
export const CONTROLLER_TRANSFER_GAS = 7000000;
export const FORCED_TRANSFER_GAS = 7000000;
...
export const SET_ADDRESS_FROZEN_GAS = 700000;
...
export const BATCH_TRANSFER_GAS = 700000;
export const BATCH_FORCED_TRANSFER_GAS = 700000;
export const BATCH_MINT_GAS = 700000;
export const BATCH_BURN_GAS = 700000;
export const BATCH_SET_ADDRESS_FROZEN_GAS = 700000;
export const BATCH_FREEZE_PARTIAL_TOKENS_GAS = 700000;
export const BATCH_UNFREEZE_PARTIAL_TOKENS_GAS = 700000;
export const RECOVERY_ADDRESS_GAS = 7000000;
export const ADD_AGENT_GAS = 7000000;
export const REMOVE_AGENT_GAS = 7000000;
