...
import {
  OperatorClearingRedeemFromByPartitionCommand,
  OperatorClearingRedeemFromByPartitionCommandResponse,
} from './OperatorClearingRedeemFromByPartitionCommand.js';
...
@CommandHandler(OperatorClearingRedeemFromByPartitionCommand)
export class OperatorClearingRedeemFromByPartitionCommandHandler
  implements ICommandHandler<OperatorClearingRedeemFromByPartitionCommand>
{
  constructor(
  ...
  async execute(
    command: OperatorClearingRedeemFromByPartitionCommand,
  ): Promise<OperatorClearingRedeemFromByPartitionCommandResponse> {
    ...
    if (!res.id)
      throw new Error(
        'Operator Create Clearing Redeem From By Partition Command Handler response id empty',
      );
    ...
    return Promise.resolve(
      new OperatorClearingRedeemFromByPartitionCommandResponse(
