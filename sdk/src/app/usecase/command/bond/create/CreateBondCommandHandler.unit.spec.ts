...
import { CreateBondCommandFixture } from '../../../../../../test/fixtures/bond/BondFixture.js';
...
describe('CreateBondCommandHandler', () => {
  ...
  const contractResult = EvmAddressFixture.create();
  ...
  describe('execute', () => {
    ...
    describe('success cases', () => {
      it('should successfully create a bond with bondAddress in response', async () => {
        ...
        expect(mirrorNodeAdapterMock.accountToEvmAddress).toHaveBeenCalledTimes(
          1,
        );
