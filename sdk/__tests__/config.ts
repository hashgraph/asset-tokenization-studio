...
// Account P
export const CLIENT_PRIVATE_KEY_ECDSA_P = new PrivateKey({
  key: process.env.CLIENT_PRIVATE_KEY_ECDSA_5 ?? '',
  type: 'ECDSA',
});
export const CLIENT_PUBLIC_KEY_ECDSA_P = new PublicKey({
  key: process.env.CLIENT_PUBLIC_KEY_ECDSA_5 ?? '',
  type: 'ECDSA',
});
export const CLIENT_EVM_ADDRESS_ECDSA_P =
  process.env.CLIENT_EVM_ADDRESS_ECDSA_5 ?? '';
export const CLIENT_ACCOUNT_ID_ECDSA_P =
  process.env.CLIENT_ACCOUNT_ID_ECDSA_5 ?? '';
export const CLIENT_ACCOUNT_ECDSA_P: Account = new Account({
  id: CLIENT_ACCOUNT_ID_ECDSA_P,
  evmAddress: CLIENT_EVM_ADDRESS_ECDSA_P,
  privateKey: CLIENT_PRIVATE_KEY_ECDSA_P,
  publicKey: CLIENT_PUBLIC_KEY_ECDSA_P,
});
export const HEDERA_ID_ACCOUNT_ECDSA_P = HederaId.from(
  CLIENT_ACCOUNT_ID_ECDSA_P,
);

// Account I
export const CLIENT_PRIVATE_KEY_ECDSA_I = new PrivateKey({
  key: process.env.CLIENT_PRIVATE_KEY_ECDSA_6 ?? '',
  type: 'ECDSA',
});
export const CLIENT_PUBLIC_KEY_ECDSA_I = new PublicKey({
  key: process.env.CLIENT_PUBLIC_KEY_ECDSA_6 ?? '',
  type: 'ECDSA',
});
export const CLIENT_EVM_ADDRESS_ECDSA_I =
  process.env.CLIENT_EVM_ADDRESS_ECDSA_6 ?? '';
export const CLIENT_ACCOUNT_ID_ECDSA_I =
  process.env.CLIENT_ACCOUNT_ID_ECDSA_6 ?? '';
export const CLIENT_ACCOUNT_ECDSA_I: Account = new Account({
  id: CLIENT_ACCOUNT_ID_ECDSA_I,
  evmAddress: CLIENT_EVM_ADDRESS_ECDSA_I,
  privateKey: CLIENT_PRIVATE_KEY_ECDSA_I,
  publicKey: CLIENT_PUBLIC_KEY_ECDSA_I,
});
export const HEDERA_ID_ACCOUNT_ECDSA_I = HederaId.from(
  CLIENT_ACCOUNT_ID_ECDSA_I,
);
