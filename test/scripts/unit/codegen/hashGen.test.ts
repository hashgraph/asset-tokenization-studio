...
import { HASHES, HASH_KINDS, isHashKind } from "../../../../lib/codegen/hashGen";

// Golden known-answer tests (KAT). Each value is the canonical hash produced
// by the hashGen formula for the named PascalCase argument, captured at the
...
describe("lib/codegen/hashGen — canonical hashes", () => {
...
// that would pass the KATs above (e.g. by adjusting both formula AND expected
// values together) but break the underlying spec.
describe("lib/codegen/hashGen — invariants", () => {
...
describe("lib/codegen/hashGen — type surface", () => {
