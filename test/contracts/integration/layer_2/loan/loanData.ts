 ...
 *
 * The Loan asset type is not deployed through the production factory; the LoanFacet is exercised
 * here against the shared AssetMock mega-asset. This module co-locates the loan test data with its
 * sole consumer (`loan.test.ts`): the default loan parameters and the `getLoanDetails` builder
 * that produces `setLoanDetails` input.
 */

import { ethers } from "hardhat";
import { DeepPartial, TIME_PERIODS_S } from "@lib";
