...
import { ADDRESS_ZERO, ATS_ROLES, EIP1066_CODES, EMPTY_HEX_BYTES, EMPTY_STRING, ZERO, RESOLVER_KEYS } from "@lib";
...
export function complianceByPartitionTests(getCtx: () => AssetMockCtx): void {
