...
export function maturityTests(getCtx: () => AssetMockCtx): void {
  describe("Maturity Tests", () => {
    ...
    beforeEach(async () => {
      ...
      // The mega-mock starts in EVM-default state: grant the roles, set up issuer and
      // KYC, and set the maturity date via the real role-gated setter.
      ...
      // Set a future maturity date so the bond is not yet matured.
