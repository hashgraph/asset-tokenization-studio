...
import { DEFAULT_PARTITION, EMPTY_STRING, ZERO, EMPTY_HEX_BYTES, ADDRESS_ZERO, ATS_ROLES, RESOLVER_KEYS } from "@lib";
...
export function controllerHoldByPartitionTests(getCtx: () => AssetMockCtx): void {
