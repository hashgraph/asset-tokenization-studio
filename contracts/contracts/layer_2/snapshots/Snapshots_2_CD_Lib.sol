...
library Snapshots_2_CD_Lib {
    function updateABAFSnapshot() external {
        CD_Lib.delegateCall(abi.encodeWithSignature('updateABAFSnapshot()'));
    }

    function updateDecimalsSnapshot() external {
        CD_Lib.delegateCall(
            abi.encodeWithSignature('updateDecimalsSnapshot()')
        );
    }
