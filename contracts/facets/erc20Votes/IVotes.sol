...
interface IVotes {
     ...
     * @param _delegatee Address that will receive the caller's voting power.
     */
     ...
     * @param _account Address whose current vote weight is queried.
     ...
     * @param _account Address whose historical vote weight is queried.
     * @param _timepoint Block number or timestamp at which the weight is resolved.
     ...
     * vote.
     * @param _timepoint Block number or timestamp at which the total supply is resolved.
     ...
     * @param _account Address whose chosen delegate is queried.
