...
/* solhint-disable */
/**
 * @notice Concrete test-only implementation of Pause.
 *         Exposes backdoor helpers so tests can exercise initializePause()
 *         from Pause.sol (which DiamondCutManager/BLR inherits but never calls directly).
 */
contract PauseTestHelper is Pause {
