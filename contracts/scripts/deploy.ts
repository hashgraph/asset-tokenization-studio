    ...
    const commands = {
        ...
        erc1410ReadFacet: new DeployContractWithFactoryCommand({
            factory: getFactory(
                ...
                new ERC1410ReadFacet__factory() // No TimeTravel version needed
            ),
            signer,
            deployedContract: useDeployed
        ...
        erc1410TransferFacet: new DeployContractWithFactoryCommand({
            factory: getFactory(
                ...
                new ERC1410TransferFacet__factory() // No TimeTravel version needed
            ),
            signer,
            deployedContract: useDeployed
        ...
        erc1410ManagementFacet: new DeployContractWithFactoryCommand({
            factory: getFactory(
                ...
                new ERC1410ManagementFacet__factory() // No TimeTravel version needed
            ),
            signer,
            deployedContract: useDeployed
