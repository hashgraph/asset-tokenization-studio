# CouponSecurityHolders

_Asset Tokenization Studio Team_

> CouponSecurityHolders

Abstract implementation of `ICouponSecurityHolders`.

_All functions are guarded by `onlyMatchingActionType(CORPORATE_ACTION_TYPE_COUPON, …)` and delegate storage reads to `CouponStorageWrapper`._
