...
Interface for the protected-partitions capability, which restricts token transfers to holders of the appropriate partition role when protection is active.
