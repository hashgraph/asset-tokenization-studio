...
Diamond facet exposing lost-wallet recovery operations.

_Registers two selectors: recoveryAddress and isAddressRecovered. All business logic is provided by the {Recovery} abstract contract._
