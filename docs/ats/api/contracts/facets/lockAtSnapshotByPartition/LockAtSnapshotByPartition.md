# LockAtSnapshotByPartition

_Asset Tokenization Studio Team_

> LockAtSnapshotByPartition

Abstract implementation of `ILockAtSnapshotByPartition`.

_Delegates all storage reads to `SnapshotsStorageWrapper`. Intended to be inherited solely by `LockAtSnapshotByPartitionFacet`._
