...
_Inherits `ExternalControlListManagement` for the business logic and implements `IStaticFunctionSelectors` for the Diamond resolver pattern. The resolver key `RESOLVER_KEY_EXTERNAL_CONTROL_LIST` identifies this facet within the diamond proxy._
