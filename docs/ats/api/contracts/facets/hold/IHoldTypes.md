...
Single source of truth for all Hold domain types (structs, enums, events, errors).

_Inherited by writer interfaces in the hold subsystem so they share a canonical ABI for hold lifecycle data._
