...
Abstract facet implementing the voting-rights corporate action lifecycle.

_Delegates persistence to `VotingStorageWrapper`; access is gated by `ROLE_CORPORATE_ACTION` and the standard activation/pause modifiers._
