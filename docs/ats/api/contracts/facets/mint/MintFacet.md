...
Diamond facet exposing the consolidated token issuance entry points.

_Registers four selectors: `initializeERC1594`, `isIssuable`, `issue` and `mint`. Inherits the business logic from the `Mint` abstract contract._
