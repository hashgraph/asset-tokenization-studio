...
Diamond facet that exposes KPI data management to the proxy.

_Selectors exposed: - `initializeKpis` - `addKpiData` - `getLatestKpiData` - `getMinDate` - `isCheckPointDate`_
