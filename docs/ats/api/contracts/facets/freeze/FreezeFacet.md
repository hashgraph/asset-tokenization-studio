...
_Inherits `Freeze` for the business logic and implements `IStaticFunctionSelectors` for the Diamond resolver pattern. The resolver key `RESOLVER_KEY_FREEZE` identifies this facet within the diamond proxy._
