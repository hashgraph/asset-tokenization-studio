...
Interface for the unprotected clearing hold creation operations scoped to a partition.

_Extends IClearingTypes. Covers the self-initiated and third-party-authorized clearing hold creation paths plus the corresponding read query. The protected variant (protectedClearingCreateHoldByPartition) is declared in IProtectedClearingHoldByPartition._
