# ClearingHoldByPartition

_Asset Tokenization Studio Team_

> ClearingHoldByPartition

Abstract implementation of the unprotected clearing hold creation operations by partition.

_Implements clearingCreateHoldByPartition (self-initiated), clearingCreateHoldFromByPartition (third-party-authorized), and getClearingCreateHoldForByPartition (read). Intended to be inherited by ClearingHoldByPartitionFacet._
