...
Abstract base that registers the TransferAndLock selectors and interface IDs for Diamond facets that extend this capability.

_Concrete subclasses supply the resolver key and initialiser key via overrides._
