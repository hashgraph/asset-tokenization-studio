...
Manages a fixed interest rate and its decimal precision for an asset.

_Uses shared storage wrappers and lifecycle modifiers to initialise and update the rate._
