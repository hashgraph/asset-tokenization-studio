...
_Registers four selectors: transfer, transferFrom, transferWithData, and transferFromWithData. Inherits all business logic from the Transfer abstract contract._
