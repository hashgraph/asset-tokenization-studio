...
Diamond facet exposing token-holder-initiated partition transfers.

_Registers one selector: transferByPartition. All business logic is provided by the {TransferByPartition} abstract contract._
