...
Diamond facet that exposes operator-clearing-hold-by-partition operations to the proxy.

_Selectors exposed: - `initializeOperatorClearingHoldByPartition` - `operatorClearingCreateHoldByPartition`_
