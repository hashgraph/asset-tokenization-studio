...
Provides vote delegation and historical voting power queries for an ERC20 asset.

_Delegates storage and vote accounting to ERC20VotesStorageWrapper. Initialisation is restricted to the default admin and may only occur before the facet is registered as ready._
