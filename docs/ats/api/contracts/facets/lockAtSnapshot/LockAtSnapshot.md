...
Abstract implementation of `ILockAtSnapshot`.

_Delegates all storage reads to `SnapshotsStorageWrapper`. Intended to be inherited solely by `LockAtSnapshotFacet`._
