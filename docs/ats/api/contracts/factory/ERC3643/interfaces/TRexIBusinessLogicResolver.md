...
```solidity
event DiamondBatchConfigurationCreated(bytes32 configurationId, TRexIDiamondCutManager.FacetConfiguration[] facetConfigurations, bool isLastBatch, uint256 version)
```
