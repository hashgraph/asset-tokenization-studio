...
> **Note**: The web application creates standard bonds by default. For specialized bond types (Fixed Rate, KPI Linked), use the SDK or contract deployment scripts directly. See the [Developer Guide](../developer-guides/contracts/index.md) for details.
