...
import { PhosphorIcon, PopUp, Weight } from "@hashgraph/securitytoken-uicomponents";
...
import { Button, ClipboardButton, Link } from "@hashgraph/securitytoken-uicomponents/Interaction";
