...
export const GET_EXTERNAL_CONTROLS_MEMBERS = (
  securityId: string,
  start: number,
  end: number,
) => `GET_EXTERNAL_CONTROLS_MEMBERS_${securityId}_${start}_${end}`;

export const GET_EXTERNAL_CONTROL = (securityId: string) =>
  `GET_EXTERNAL_CONTROL_${securityId}`;

export const GET_IS_EXTERNAL_CONTROL = (securityId: string) =>
  `GET_IS_EXTERNAL_CONTROL_${securityId}`;

export const GET_IS_CONTROL_MOCK = (securityId: string) =>
  `GET_IS_CONTROL_MOCK_${securityId}`;
...
export const useGetExternalControls = (
  securityId: string,
  start: number = 0,
) => {
  const countQuery = useGetExternalControlListsCount(
    new GetExternalControlListsCountRequest({ securityId }),
    {
      retry: false,
    },
  );
