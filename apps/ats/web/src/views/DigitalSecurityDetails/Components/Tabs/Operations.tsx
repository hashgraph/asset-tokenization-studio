...
const operationContractTabs: Record<OperationContractType, OperationTab[]> = {
  ...
  'ERC 3643': [
    { component: <Freeze />, key: 'freeze', configKey: 'showFreeze' },
  ],
};
...
export const OperationsTab = ({ config }: OperationsTabProps) => {
  ...
  const [selectedOperationContractType, setSelectedOperationContractType] =
    useState<OperationContractType>('ERC 1400');
