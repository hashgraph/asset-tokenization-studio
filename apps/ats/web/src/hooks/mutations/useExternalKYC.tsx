...
export const useUpdateExternalKYCLists = () => {
  ...
  return useMutation(
    (req: UpdateExternalKycListsRequest) =>
      SDKService.updateExternalKycLists(req),
    {
...
export const useAddExternalKYCList = () => {
  ...
  return useMutation(
    (req: AddExternalKycListRequest) => SDKService.addExternalKycList(req),
    {
      onSuccess(data, variables) {
        queryClient.invalidateQueries({
          queryKey: [GET_EXTERNAL_KYC_COUNT(variables.securityId)],
...
export const useRemoveExternalKYCList = () => {
  ...
  return useMutation(
    (req: RemoveExternalKycListRequest) =>
      SDKService.removeExternalKycList(req),
    {
      onSuccess(data, variables) {
        queryClient.invalidateQueries({
          queryKey: [GET_EXTERNAL_KYC_COUNT(variables.securityId)],
...
export const useIsAuthorizedKYCListMock = () => {
  ...
  return useMutation(
    (req: GetKycStatusMockRequest) => SDKService.getKycStatusMock(req),
    {
      onSuccess(data) {
        console.log(
