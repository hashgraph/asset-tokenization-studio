...
export const useUpdateExternalControlLists = () => {
  ...
  return useMutation(
    (req: UpdateExternalControlListsRequest) =>
      SDKService.updateExternalControlLists(req),
    {
...
export const useAddExternalControlList = () => {
  ...
  return useMutation(
    (req: AddExternalControlListRequest) =>
      SDKService.addExternalControlList(req),
    {
      onSuccess(data, variables) {
        queryClient.invalidateQueries({
          queryKey: [GET_EXTERNAL_CONTROL_LIST_COUNT(variables.securityId)],
...
export const useRemoveExternalControlList = () => {
  ...
  return useMutation(
    (req: RemoveExternalControlListRequest) =>
      SDKService.removeExternalControlList(req),
    {
      onSuccess(data, variables) {
        queryClient.invalidateQueries({
          queryKey: [GET_EXTERNAL_CONTROL_LIST_COUNT(variables.securityId)],
...
export const useIsAuthorizedBlackListMock = () => {
  ...
  return useMutation(
    (req: IsAuthorizedBlackListMockRequest) =>
      SDKService.isAuthorizedBlackListMock(req),
    {
      onSuccess(data) {
        console.log(
...
export const useIsAuthorizedWhiteListMock = () => {
  ...
  return useMutation(
    (req: IsAuthorizedWhiteListMockRequest) =>
      SDKService.isAuthorizedWhiteListMock(req),
    {
      onSuccess(data) {
        console.log(
          "SDK message --> Is authorized address operation success: ",
