...
export default {
  list: {
    ...
    modal: {
      removeExternalControlPopUp: {
        ...
        description:
          'Are you sure you want to remove this external control? This action cannot be undone.',
  ...
  add: {
    ...
    messages: {
      ...
      isAddressAuthorized: {
        ...
        error: 'Failed: ',
        descriptionFailed:
          'There was an error checking the account. Please try again',
      },
  ...
  removeAddress: {
    ...
    description:
      'Enter the account address to remove it from external control.',
    input: {
      label: 'Account Address',
      placeholder: '0.0.123456',
    },
