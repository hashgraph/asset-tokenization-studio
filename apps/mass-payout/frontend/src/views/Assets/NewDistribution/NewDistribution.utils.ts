 ...
 *
 *    9. Accepting Warranty or Support. Unless You explicitly state otherwise,
 *       any Contribution intentionally submitted for inclusion in the Work
 *       by You to the Licensor shall be under the terms and conditions of
 *       this License, without any additional terms or conditions.
 *       Notwithstanding the above, nothing herein shall supersede or modify
...
export const isFormValid = (
  ...
  const distributionTypeValidationMap: Record<
    FormDistributionType,
    () => boolean
  > = {
    ...
    [FormDistributionType.RECURRING]: () =>
      !!recurringFrequency && !!recurringStartDate,
  };

  const validator =
    distributionTypeValidationMap[distributionType as FormDistributionType];
...
export const createPayload = (
  ...
  if (
    data.distributionType === FormDistributionType.SCHEDULED &&
    data.scheduledDate
  ) {
