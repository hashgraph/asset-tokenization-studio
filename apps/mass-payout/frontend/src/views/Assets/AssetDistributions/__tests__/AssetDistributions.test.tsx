 ...
 *       the Work and such Derivative Works in public or private.
 *
...
const mockUseGetAssetDistributions =
  useGetAssetDistributions as jest.MockedFunction<
    typeof useGetAssetDistributions
  >;
const mockUseAssetDistributionsColumns =
  useAssetDistributionsColumns as jest.MockedFunction<
