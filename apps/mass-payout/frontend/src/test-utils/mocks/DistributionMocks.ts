 ...
 *       Work in the manner specified by the author or licensor (but not in any
...
export const mockAssetDistributionService = {
  getAssetDistributions: jest
    .fn()
    .mockResolvedValue(mockDistributionsPaginatedResponse),
};
