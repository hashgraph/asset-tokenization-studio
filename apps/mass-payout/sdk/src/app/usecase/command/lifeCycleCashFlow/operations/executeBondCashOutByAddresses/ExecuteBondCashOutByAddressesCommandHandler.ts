  ...
  implements ICommandHandler<ExecuteBondCashOutByAddressesCommand>
{
  ...
  async execute(
    command: ExecuteBondCashOutByAddressesCommand
  ): Promise<ExecuteBondCashOutByAddressesCommandResponse> {
    try {
      const { lifeCycleCashFlowId, bond, holders, paymentTokenDecimals } =
        command
