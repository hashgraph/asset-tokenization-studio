...
export class ExecuteAmountSnapshotCommandHandler
  implements ICommandHandler<ExecuteAmountSnapshotCommand>
{
  constructor(
  ...
  async execute(
    command: ExecuteAmountSnapshotCommand
  ): Promise<ExecuteAmountSnapshotCommandResponse> {
    try {
      const {
        lifeCycleCashFlowId,
        asset,
