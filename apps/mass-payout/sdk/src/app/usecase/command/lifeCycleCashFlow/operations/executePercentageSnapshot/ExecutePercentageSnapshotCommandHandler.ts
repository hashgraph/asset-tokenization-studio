...
export class ExecutePercentageSnapshotCommandHandler
  implements ICommandHandler<ExecutePercentageSnapshotCommand>
{
  constructor(
  ...
  async execute(
    command: ExecutePercentageSnapshotCommand
  ): Promise<ExecutePercentageSnapshotCommandResponse> {
    try {
      const {
        lifeCycleCashFlowId,
        asset,
