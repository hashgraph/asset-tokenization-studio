...
describe("Scheduled Payouts Cron", () => {
  ...
  it(
    ...
    async () => {
      ...
      e2eTestApp.lifeCycleCashFlowMock.executeDistribution.mockResolvedValue(
        executeDistributionResponseCorporateAction,
      );
  ...
  it(
    ...
    async () => {
      ...
      const distributionsAfterCron = await internalDistributionRepository.find();
      const pastDistributionAfter = distributionsAfterCron.find(
        (d) => d.corporateActionID === "corporateActionIdToday",
      );
