...
if [[ "$OSTYPE" == "darwin"* ]]; then
  ...
  find . -path ./node_modules -prune -o -name "package.json" -type f  | grep -v node_modules | grep -v example | xargs sed -i '' "s/\"@hashgraph\/securitytoken-uicomponents\": \".*\"/\"@hashgraph\/securitytoken-uicomponents\": \"$version\"/g"
