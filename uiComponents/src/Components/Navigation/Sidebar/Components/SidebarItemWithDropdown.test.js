...
describe("<SidebarItemWithDropdown />", function () {
    var defaultProps = {
        label: "Item",
        icon: Cookie,
    ...
    var factoryComponent = function (props) {
        ...
        return render(React.createElement(Menu, null,
            React.createElement(SidebarItemWithDropdown, __assign({}, props))));
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fireEvent.mouseEnter(component.getByTestId("sidebar-item-".concat(defaultProps.label)));
    ...
    test("renders correctly with header", function () {
        var component = factoryComponent(__assign(__assign({}, defaultProps), { header: (React.createElement(Button, { variant: "secondary", size: "md" }, "Main action")) }));
        expect(component.getByTestId("sidebar-dropdown-header")).toHaveTextContent("Main action");
