...
describe("<RadioGroup />", function () {
    ...
    var defaultValueProp = { defaultValue: "check2" };
    var factoryComponent = function (props) {
        return render(React.createElement(RadioGroup, __assign({ name: "test-group" }, childrenProp, props)));
    };
    ...
    test("shows correctly when sets value by default", function () {
        var component = factoryComponent(defaultValueProp);
    ...
    test("shows correctly when is checked and disabled", function () {
        var component = factoryComponent(__assign(__assign({}, defaultValueProp), isDisabledProp));
