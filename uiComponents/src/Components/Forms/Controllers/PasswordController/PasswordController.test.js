...
describe("<PasswordController />", function () {
    ...
    var RenderWithForm = function (props) {
        ...
        return React.createElement(PasswordController, __assign({ control: control }, props));
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    passwordField = component.getByTestId("password");
                    act(function () {
    ...
    test("should be able to hide or show password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var component, toggleButton, passwordField;
        return __generator(this, function (_a) {
            component = factoryComponent();
            toggleButton = component.getByTestId("toggle-password-visibility");
            passwordField = component.getByTestId("password");
    ...
    test("should be able to change hide or show password btn icon", function () { return __awaiter(void 0, void 0, void 0, function () {
        var component, toggleButton;
        return __generator(this, function (_a) {
            component = factoryComponent(__assign(__assign({}, defaultProps), { iconShowPassword: React.createElement(Icon, { as: Eye }), iconHidePassword: React.createElement(Icon, { as: EyeSlash }) }));
            toggleButton = component.getByTestId("toggle-password-visibility");
