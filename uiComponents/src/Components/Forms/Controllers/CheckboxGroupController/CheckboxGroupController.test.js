...
describe("<CheckboxGroupController />", function () {
    var defaultProps = {
    ...
    var RenderWithForm = function (props) {
        ...
        return React.createElement(CheckboxGroupController, __assign({ control: control }, props));
    };
    ...
    test("Component renders correctly", function () {
        ...
        var opt1 = component.getByText("One");
        act(function () {
                    ...
                    component = factoryComponent(__assign(__assign({}, defaultProps), { showErrors: true, rules: {
                            validate: {
                                notTwoValue: function (value) {
                                    return value.includes("value2") || "This value is not valid";
                                }
                            }
                        } }));
                    option = component.getByText("Two");
                    act(function () {
