...
describe("<ToggleController />", function () {
    ...
    var RenderWithForm = function (props) {
        ...
        return React.createElement(ToggleController, __assign({ control: control }, props));
    };
    ...
    test("Show error at bottom", function () { return __awaiter(void 0, void 0, void 0, function () {
        var component, toggle;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    component = factoryComponent(__assign(__assign({}, defaultProps), { showErrors: true, rules: {
                            validate: { valid: function (val) { return !!val || "This is invalid"; } }
                        } }));
                    toggle = component.getByTestId("test");
                    act(function () {
