...
export var CalendarInputController = function (props) {
    var _a;
    ...
    return (React.createElement(FieldController, { fieldState: fieldState, errorMessageVariant: variant, showErrors: showErrors },
        React.createElement(CalendarInput, __assign({ "data-testid": id, name: id, isRequired: isRequired, isInvalid: !!fieldState.error, isSuccess: showIsSuccess && fieldState.isDirty && !fieldState.error, onChange: function (e) {
                onChange === null || onChange === void 0 ? void 0 : onChange(e);
                onChangeDefault(e);
            }, onBlur: function () {
                onBlur === null || onBlur === void 0 ? void 0 : onBlur();
                onBlurDefault();
            }, value: value }, _omit(props, [
            "control",
            "rules",
            "showErrors",
            "onChange",
