...
describe("<SearchInputController />", function () {
    var defaultProps = {
        ...
        label: "Search",
        onSearch: function () { return console.log("searching"); }
    };
    var RenderWithForm = function (props) {
        ...
        return React.createElement(SearchInputController, __assign({ control: control }, props));
    };
    ...
    test("Component renders correctly", function () {
        ...
        var passwordField = component.getByTestId("search");
    ...
    test("should allow to search when min characters are reached", function () { return __awaiter(void 0, void 0, void 0, function () {
        var component, searchButton, inputField;
        return __generator(this, function (_a) {
            component = factoryComponent();
            searchButton = component.getByTestId("search-icon-button");
            inputField = component.getByTestId("search");
