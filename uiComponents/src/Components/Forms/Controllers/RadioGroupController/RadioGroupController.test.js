...
describe("<RadioGroupController />", function () {
    var defaultProps = {
    ...
    var RenderWithForm = function (props) {
        ...
        return React.createElement(RadioGroupController, __assign({ control: control }, props));
    };
    ...
    test("Component renders correctly", function () {
        ...
        var opt1 = component.getByRole("radio", { name: "One" });
        act(function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    opt1 = component.getByRole("radio", { name: "One" });
                    act(function () {
                        fireEvent.click(opt1);
                    });
                    return [4 /*yield*/, waitFor(function () {
