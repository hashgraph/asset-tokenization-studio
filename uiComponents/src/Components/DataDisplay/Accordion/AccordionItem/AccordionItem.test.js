...
describe("<AccordionItem />", function () {
    var factoryComponent = function (props) {
        ...
        return render(React.createElement(Accordion, { title: "Accordion Test" },
            React.createElement(AccordionItem, __assign({}, props))));
    };
    ...
    test("onclick should expand and show children", function () { return __awaiter(void 0, void 0, void 0, function () {
        var component;
    ...
    test("should render custom title", function () { return __awaiter(void 0, void 0, void 0, function () {
        var customProps, component;
        return __generator(this, function (_a) {
            customProps = {
                children: React.createElement(Text, null, text),
                customTitle: React.createElement(CustomTitleComponent, null)
            };
            component = factoryComponent(customProps);
