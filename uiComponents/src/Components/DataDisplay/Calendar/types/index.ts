...
export const calendarPartsList: Array<
  | "footer"
  | "header"
  | "container"
  | "headerTitle"
...
export type MonthProps = ButtonProps &
  CalendarConfigProps & {
    isSelected: boolean;
    onClick: () => void;
    label: string;
...
export type CalendarThemeStyle = Partial<
  Record<Parts[number], ChakraSystemStyleObject>
>;
...
export type CalendarProps = DayPickerProps &
  Pick<CalendarConfigProps, "colorScheme" | "isDisabled"> &
  ChakraStyledOptions & {
    variant?: string;
