...
import { GridItem, useMultiStyleConfig as useChakraMultiStyleConfig, } from "@chakra-ui/react";
import { MenuItem } from "@chakra-ui/menu";
import { useCalendarContext } from "../../context";
export var Year = function (_a) {
    ...
    return (React.createElement(GridItem, null,
        React.createElement(MenuItem, __assign({ sx: styles.year }, props), label)));
};
