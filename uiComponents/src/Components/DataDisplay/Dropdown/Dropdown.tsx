...
export const dropdownPartsList: Array<
  "wrapper" | "container" | "itemIconWeight" | "itemLabel" | "itemContainer"
> = ["wrapper", "container", "itemIconWeight", "itemLabel", "itemContainer"];
...
export interface DropdownThemeConfiguration
  ...
  baseStyle:
    | (({
        ...
        hasMaxHeight,
        hasMaxWidth,
      }: DropdownConfigProps) => Partial<DropdownThemeStyle>)
    | PartsStyleInterpolation<Parts>;
}

export type DropdownThemeStyle = Record<
  Parts[number],
...
export const Dropdown = ({ children, variant, ...props }: DropdownProps) => {
  ...
  return (
    <ChakraMenuList position="relative" sx={styles.wrapper} {...props}>
