 ...
 * lib/core modules. For new code, use:
 * - lib/core/constants.ts for network constants and defaults
 * - lib/core/config.ts for network configuration
 * - lib/core/registry.ts for contract metadata
 *
